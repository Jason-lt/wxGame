...
cc._RF.push(module, '13519udZ1VM2JsPUZDM5eJG', 'TCP', __filename);
...
ty.TCP = {
    ...
    connect: function connect(url) {
        ...
        wx.onSocketMessage(function (res) {
            ...
            if (strJson != null && strJson.length > 0) {
                ...
                if (double.msgCache.blocked) {
                    double.msgCache.pushMsg(_json);
                } else {
    ...
    triggerMsg: function triggerMsg(msg) {
        // if (msg.cmd == double.EventType.MSG_LED){
    ...
    sendMsg: function sendMsg(data) {
        ...
        wx.sendSocketMessage({
            ...
            success: function success(params) {
                ...
                // hall.LOGD(null, 'TCP sendMsg success:' + JSON.stringify(data));
            },
