...
cc._RF.push(module, '20acc9H6lhNMpYVb2P9GQs5', 'boot', __filename);
// Script/hall/boot.js
...
//
// //如果文件里存了音量信息，则进行设置
// var mute = hall.GlobalFuncs.ReadBoolFromLocalStorage(double.SETTING_MUTE_KEY, false);
// if (mute) {
//     double.AudioHelper.setMusicVolume(0);
//     double.AudioHelper.setEffectsVolume(0);
// } else {
//     var music_vol = hall.GlobalFuncs.ReadNumFromLocalStorage(double.SETTING_MUSIC_KEY, 0.5); //如果没有存储，初始默认值0.5
//     double.AudioHelper.setMusicVolume(music_vol);
//     var effect_vol = hall.GlobalFuncs.ReadNumFromLocalStorage(double.SETTING_EFFECT_KEY, 1); //如果没有存储，初始默认值1
//     double.AudioHelper.setEffectsVolume(effect_vol);
// }
