...
double.EventType = {
    ...
    GAME_START_LEVEL_UP : "GAME_START_LEVEL_UP",
    GAME_OVER : "GAME_OVER",
    GAME_CONTINUE : "GAME_CONTINUE",
    GAME_LEVEL_UP : "GAME_LEVEL_UP",
    GAME_OBJECT_UP : "GAME_OBJECT_UP",
    CHANGE_GUN_TYPE : "CHANGE_GUN_TYPE",//更换武器
    CHANGE_WEAPONSDEPOT_STATE : "CHANGE_WEAPONSDEPOT_STATE",//更换武器库中排列
    UPDATE_RESULT_RANK : "UPDATE_RESULT_RANK",//更新结算页面(排行榜返回)

    GAME_ROLL_STOP : "GAME_ROLL_STOP",

    TITLE_PAGE_REVIEW : "TITLE_PAGE_REVIEW",
    // // GAME_OVER : "GAME_OVER",
