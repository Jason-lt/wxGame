...
ctr.sxAdmanager = {
    ...
    loadConfigFile: function (callback) {
        try {
            ...
            // xhr.open("GET", "https://sanxqn.nalrer.cn/tysanxiao/double/adconfig/configDaoLiu1.json", true);
            ...
            //                 console.log('sxAdInfo:', self.sxAdInfo);
            //                 callback();
            //             } catch (e) {
    ...
    selectItemByWeight(num, arr) {
        console.log('selectItemByWeight', num);
        console.log(arr);
        let limit = 0;
