require = function() {
  ...
  AdManager: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "33124y9QPBMrJgxISvLKBIE", "AdManager");
    "use strict";
    hall.adManager = {
      ...
      showBannerAd: function showBannerAd(adid, refresh) {
        if (!double.GameWorld.gunnerShareSchemeConfig || !double.GameWorld.gunnerShareSchemeConfig.showBanner) return;
        ...
        } else double.curBannerAd = wx.createBannerAd({
          adUnitId: adid,
          style: {
            left: 0,
            top: top,
        ...
        double.curBannerAd.onResize(function(res) {
          ...
          if (double.curBannerAd) {
            ...
            top = res.height;
            ty.UserInfo.systemType == ty.UserInfo.SYSTEMTYPE.iPhoneXType ? double.curBannerAd.style.top = screenHeight - top - 30 : double.curBannerAd.style.top = screenHeight - top;
          }
        });
        double.curBannerAd.show();
      },
      hideBannerAd: function hideBannerAd() {
        double.curBannerAd && double.curBannerAd.hide();
      },
      ...
      requestLocalIPInfo: function requestLocalIPInfo() {
        ...
        wx.request({
          ...
          success: function success(res) {
            ...
            res.data.loc && res.data.loc[2] && (ty.UserInfo.isInBSGS = hall.GlobalFuncs.checkBSGS(res.data.loc[2]));
          },
          fail: function fail(res) {}
        });
      },
  ...
  BiLog: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "4e8c6PbYz9AI6jpHWNY6WK5", "BiLog");
    "use strict";
    ty.BiLog = {
  ...
  EventType: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "0f9d42zh2pDZJUnOUEHci21", "EventType");
    "use strict";
  ...
  GameModel: [ function(require, module, exports) {
    ...
    double.gameModel = {
      ...
      GAME_BEST_SCORE: "GAME_BEST_SCORE",
      GAME_NEWEST_OBJECT_INDEX: "GAME_NEWEST_OBJECT_INDEX",
      GAME_COIN_NUMBER: "GAME_COIN_NUMBER",
      GAME_STAGE_BOX_NUMBER: "GAME_STAGE_BOX_NUMBER",
      rankWindow: null,
      titlePage: null,
      weaponsDepot: null,
      newWeapon: null,
  ...
  GlobalFuncs: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "23c1exXY0tP0L+lq2lMvMPG", "GlobalFuncs");
    "use strict";
    hall.GlobalFuncs = {};
    hall.SceneGather = [];
    ...
    hall.GlobalFuncs.replaceKeyWordInString = function(string) {
      ...
      var replaceMap = double.Share.shareKeywordReplace;
  ...
  GlobalTimer: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "a58181/q7dEzpK8FTtkT+of", "GlobalTimer");
    "use strict";
    hall.GlobalTimer = {
      boot: function boot() {
        this.MAX_COUNT = 30;
  ...
  HallGameWorld: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2387beqrhNObqMzJkIAcEY6", "HallGameWorld");
    "use strict";
  ...
  HallNetWorkCenter: [ function(require, module, exports) {
    ...
    hall.hallNetWorkCenter = {
      ...
      onGameData: function onGameData(argument) {
        ...
        if ("undefined" != typeof argument) {
          if (!hall.GlobalFuncs.checkMsgWithGameId(argument, double.GameId)) return;
      ...
      onReceiveUserInfo: function onReceiveUserInfo(value) {
        ...
        query && query.sourceCode ? ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeUserFrom, [ scene, query.inviteCode, double.Share.clickStatShareType[query.sourceCode], query.imageType, "GameStart", JSON.stringify(sceneInfo) ]) : ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeUserFrom, [ scene, query.from, query.appid, "GameStart", JSON.stringify(sceneInfo) ]);
        double.Share.isOnShare && double.Share.playAnimationAfterShareWithType();
    ...
    doubleEventType: "doubleEventType"
  } ],
  HallUserInfo: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "6d5942BleZHfb2hDGcDAoqB", "HallUserInfo");
    "use strict";
  ...
  HttpUtil: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "d18canrffZHb7gMUXgf6bfv", "HttpUtil");
    "use strict";
    ty.HttpUtil = {
  ...
  MsgCache: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "e8377xpdLtBYIxgwfueDSNM", "MsgCache");
    "use strict";
    double.msgCache = {
      needCacheMsg: {
  ...
  NotificationCenter: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "cae79zNL5tP3ZL2YIff9TiI", "NotificationCenter");
    "use strict";
  ...
  PropagateInterface: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "c38e375M9BN+JSCe1CyputZ", "PropagateInterface");
    "use strict";
  ...
  ServerManager: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "e027fStkhhCNKTAzG5NRsAS", "ServerManager");
    "use strict";
    cc.Class({
  ...
  ServerStateManager: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "61371E0RzRKb5pO1SvO+9aR", "ServerStateManager");
    "use strict";
    require("HttpUtil");
  ...
  Share: [ function(require, module, exports) {
    (function(Buffer) {
      "use strict";
      cc._RF.push(module, "2d3834c6XVBmbt4j7A41PFd", "Share");
      "use strict";
      var crypto = require("crypto");
      double.Share = {
        ...
        shareWithType: function shareWithType(type, successCallBackFun, failCallBackFun, testCfg) {
          ...
          } else double.Share.shareQuery = "";
          shareDetail.unSensitivePersonage ? double.Share.unSensitivePersonage = shareDetail.unSensitivePersonage : double.Share.unSensitivePersonage = 0;
          ...
          } else double.Share.shareImformation(type, shareCfg, shareTitle, shareImage, query, shareDetail.sharePoint, successCallBackFun, failCallBackFun);
        },
        ...
        playAnimationAfterShareWithType: function playAnimationAfterShareWithType() {
          ...
          if (double.Share.shareType == double.Share.onShareType.clickStatShareTypeRankList && double.Share.shareTicket && "" != double.Share.shareTicket) {
            double.GlobalFuncs.showRankList(double.Share.shareTicket);
            double.Share.shareType = "";
            double.Share.resultType = 0;
            return;
          }
          if (!double.Share.unSensitivePersonage || 1 == double.Share.unSensitivePersonage) {
          ...
          if (2 == double.Share.unSensitivePersonage) try {
            wx.getShareInfo({
        ...
        endWithSuccessShare: function endWithSuccessShare() {
          ...
          double.Share.shareType != double.Share.onShareType.clickStatShareTypeRevial && double.Share.sharePoint > 1e4;
          ty.NotificationCenter.trigger(double.EventType.UPDATE_SHARE_STATE, double.Share.shareType);
        },
  ...
  SystemInfo: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "e219eM3feNP56YFcZtxyy2w", "SystemInfo");
    "use strict";
  ...
  TCP: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "13519udZ1VM2JsPUZDM5eJG", "TCP");
    "use strict";
      ...
      connect: function connect(url) {
        ...
        wx.onSocketMessage(function(res) {
          ...
          if (null != strJson && strJson.length > 0) {
            ...
            double.msgCache.blocked ? double.msgCache.pushMsg(_json) : self.triggerMsg(_json);
          }
        });
      },
  ...
  Timer: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "4a21c4wNXNP7KMCNjeqEGiV", "Timer");
    "use strict";
    ty.Timer = {
  ...
  ToDoTasks: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "fde35kK2DhCq4Ig16IROUje", "ToDoTasks");
    "use strict";
    var _typeof = "function" === typeof Symbol && "symbol" === typeof Symbol.iterator ? function(obj) {
      return typeof obj;
    } : function(obj) {
  ...
  TodoTaskVec: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "18891q3FRpDKZzxgOOO6peX", "TodoTaskVec");
    "use strict";
    cc.Class({
      ctor: function ctor() {
        this.gameId = 0;
  ...
  TuyooSDK: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2a1ff3UaalGCL32rrcdlLsh", "TuyooSDK");
    "use strict";
    ...
    ty.TuyooSDK = {
      ...
      loginTuyooWithCode: function loginTuyooWithCode(code, userInfo, iv, encryptedData) {
        ...
        var sdkPath = ty.SystemInfo.loginUrl;
        debugMode = hall.GlobalFuncs.ReadBoolFromLocalStorage(double.gameModel.DEBUG_MODE, debugMode);
        debugMode && (sdkPath = hall.GlobalFuncs.ReadStringFromLocalStorage(ty.SystemInfo.DEBUG_SER_KEY, ty.SystemInfo.loginUrl));
        ...
        try {
          wx.request({
            ...
            success: function success(params) {
              ...
              double.Share.shareKeywordReplace.nickName = hall.GlobalFuncs.sliceStringToLength(ty.UserInfo.userName, 10);
    ...
    wx.onShow(function(result) {
      ...
      } else query && query.sourceCode ? ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeUserFrom, [ scene, query.inviteCode, double.Share.clickStatShareType[query.sourceCode], query.imageType, "CardActive", JSON.stringify(result) ]) : ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeUserFrom, [ scene, query.from, query.appid, "CardActive", JSON.stringify(result) ]);
      if (query && query.sourceCode) {
        if (query.sourceCode == double.Share.onShareType.clickStatShareTypeRankList && 1044 == scene) {
          var shareTicket = result.shareTicket;
          shareTicket && double.GlobalFuncs.showRankList(shareTicket);
        }
        if (query && query.propBoxID) {
          double.Share.shareKeywordReplace.boxId = query.propBoxID;
          ty.SystemInfo.boxId = query.propBoxID;
        }
        if (query && query.giftBagBoxId) {
          double.Share.shareKeywordReplace.mysteryGiftBagBoxId = query.giftBagBoxId;
          ty.SystemInfo.mysteryGiftBagBoxId = query.giftBagBoxId;
        }
      }
      if (double.needReLogin) {
        hall.LoginToyoo();
        double.needReLogin = null;
      }
  ...
  UserInfoUData: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "81dccKMQVlI173kc2UD1Iai", "UserInfoUData");
    "use strict";
  ...
  UserInfo: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "16498+sVNJJ+IO2eyCAX+f7", "UserInfo");
    "use strict";
  ...
  addScore: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "c2c3eZcnV5BJau/Zf3LONm2", "addScore");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      changeLabel: function changeLabel() {
        this.scoreLabel.string = double.GameWorld.totalLevel;
      }
    });
    cc._RF.pop();
  }, {} ],
  boot: [ function(require, module, exports) {
    ...
    hall.LoginToyoo = function() {
      if (wx.hasOwnProperty("getUpdateManager")) {
        ...
        updateManager.onCheckForUpdate(function(res) {
          double.LOGD(null, res.hasUpdate);
        });
              ...
              wx.getSetting({
                success: function success(res) {
                  if (res.authSetting["scope.userInfo"]) {
                    ...
                    var openData = double.GlobalFuncs.getOpenData();
                    if (openData) {
    ...
    ToDoTasks: "ToDoTasks",
    doubleAudioHelper: "doubleAudioHelper",
    doubleEventType: "doubleEventType"
  } ],
  debugNode: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "9cd31ybRb1L+Z0isXunrzWB", "debugNode");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
  ...
  doubleAudioHelper: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "7e8d6z29ZhJw69yCQxj5vSW", "doubleAudioHelper");
    "use strict";
    double.AudioHelper = {
      ...
      playEffect: function playEffect(file, isloop, volume) {
        ...
        playManager.loop = isloop;
        playManager.src = ty.SystemInfo.cdnPath + file;
        "/resources/sound/gundouble.mp3" == file && (playManager.src = file);
      ...
      setEffectsVolume: function setEffectsVolume(val) {
        hall.GlobalFuncs.setInLocalStorage(double.SETTING_EFFECT_KEY, val);
        cc.audioEngine.setEffectsVolume(val);
      },
      setMusicVolume: function setMusicVolume(val) {
        hall.GlobalFuncs.setInLocalStorage(double.SETTING_MUSIC_KEY, val);
        cc.audioEngine.setMusicVolume(val);
      },
      getMusicVolume: function getMusicVolume() {
        return hall.GlobalFuncs.ReadNumFromLocalStorage(double.SETTING_MUSIC_KEY, cc.audioEngine.getMusicVolume());
      },
      getEffectsVolume: function getEffectsVolume() {
        return hall.GlobalFuncs.ReadNumFromLocalStorage(double.SETTING_EFFECT_KEY, cc.audioEngine.getEffectsVolume());
      }
    };
    cc._RF.pop();
  }, {} ],
  doubleEventType: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "213488JTL1IzpyFPiEtySAV", "doubleEventType");
    "use strict";
    ...
    double.EventType = {
      ...
      CHANGE_GUN_TYPE: "CHANGE_GUN_TYPE",
      GAME_ROLL_STOP: "GAME_ROLL_STOP",
      REPLAY_BG_MUSIC: "REPLAY_BG_MUSIC"
    };
    cc._RF.pop();
  }, {} ],
  doubleGlobalFuncs: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "423dcQUPz9PVL48xJxlq+qX", "doubleGlobalFuncs");
    "use strict";
    double.GlobalFuncs = {};
    ...
    double.GlobalFuncs.showAdBtnWithTag = function(tag, growth) {
      ...
      if ("double_main" != curScene.name) return;
      ...
      if (!double.gameModel.getAllCheckConfig()) {
        var tempY = 280;
        ty.UserInfo.systemType == ty.UserInfo.SYSTEMTYPE.iPhoneXType && (tempY = 350);
        double.GameWorld.growthConfig[growth].indexOf("CO") > -1 ? 1 != hall.GlobalFuncs.ReadNumFromLocalStorage(double.gameModel.OPEN_ADBTN_STATE_TODAY, 0) && (hall.adManager.getAdNodeByTag(tag) ? hall.adManager.getAdNodeByTag(tag).showAdNode() : hall.adManager.showAd({
          x: 52,
          y: tempY
        }, tag)) : double.GameWorld.growthConfig[growth].indexOf("STU") > -1 && 2 != hall.GlobalFuncs.ReadNumFromLocalStorage(double.gameModel.OPEN_ADBTN_STATE_TODAY, 0) && double.sxAdmanager.show(65, tempY, .6);
      }
    };
    double.GlobalFuncs.hideAdBtnWithTag = function(tag, hideSx) {
      hall.adManager.getAdNodeByTag(tag) && hall.adManager.getAdNodeByTag(tag).hideAdNode();
      hideSx && double.sxAdmanager.hide();
    };
    ...
    double.GlobalFuncs.showNewResult = function() {
      ...
      } else cc.loader.loadRes("double_prefabs/double_newResult", function(err, prefab) {
        var preFabNode = cc.instantiate(prefab);
    ...
    double.GlobalFuncs.showTitlePage = function() {
      if (double.gameModel.titlePage) {
        ...
        com.updateTitlePage();
      } else cc.loader.loadRes("double_prefabs/double_titlePage", function(err, prefab) {
        var preFabNode = cc.instantiate(prefab);
    ...
    double.GlobalFuncs.showWeaponsDepot = function() {
      ...
      } else cc.loader.loadRes("double_prefabs/double_weaponsDepot", function(err, prefab) {
        var preFabNode = cc.instantiate(prefab);
    ...
    double.GlobalFuncs.showWindowNewWeapon = function(type, objectTypeIndex) {
      ...
      } else cc.loader.loadRes("double_prefabs/double_window_newWeapon", function(err, prefab) {
        var preFabNode = cc.instantiate(prefab);
    ...
    double.GlobalFuncs.showRankList = function(shareTicket) {
      double.gameModel.rankWindow ? double.gameModel.rankWindow.changeButtonToRank(shareTicket) : cc.loader.loadRes("double_prefabs/double_rank", function(err, prefab) {
        var preFabNode = cc.instantiate(prefab);
        var curScene = cc.director.getScene();
        if (curScene) {
  ...
  doubleNetWorkCenter: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "3fc73tgjHFG/bFE2/DsgCML", "doubleNetWorkCenter");
    "use strict";
    ...
    double.NetWorkCenter = {
      ...
      onShare2: function onShare2(msg) {
        ...
        if (msg.result.action == double.EventType.GET_REWARD) {
          if (double.waitGetRevial && "waitRecive" == double.waitGetRevial.type && msg.result.rewards.length > 0) {
            ...
            if (msg.result.rewards[0].count) {
              ...
              if ("item:1371" == msg.result.rewards[0].itemId) double.GlobalFuncs.playGetPropBoxAni(0, _count); else if ("item:1372" == msg.result.rewards[0].itemId) double.GlobalFuncs.playGetPropBoxAni(1, _count); else if ("item:1390" == msg.result.rewards[0].itemId) {
        ...
        } else msg.result.action == double.EventType.CHECK_REWARD && ty.NotificationCenter.trigger(double.EventType.GET_CHECK_REWARD, msg.result);
      },
      onReceiveTCP_Msg: function onReceiveTCP_Msg(value) {
        var msgCmd = value.cmd;
        var result = value.result;
  ...
  double_arrow: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "544f2FKI6tB9om8P/HSkPet", "double_arrow");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      onLoad: function onLoad() {},
      reSetArrowSprite: function reSetArrowSprite(arrowSpriteFrame) {
        this.arrowSprite.spriteFrame = arrowSpriteFrame;
      },
      beginSendAnimation: function beginSendAnimation(direction, from) {
        this.node.rotation = 360 * (1 - direction / (2 * Math.PI));
      ...
      hitObject: function hitObject() {
        this.doAnimation = false;
        var manager = cc.director.getCollisionManager();
        manager.enabled = false;
        this.verticalSpeed = 0;
        this.horizontalSpeed = 0;
        0 == double.GameWorld.weaponType ? this.parentScene.receiveBullet(this.node, this.direction, this.fromDirection) : this.parentScene.receiveArrow(this.node, this.direction, this.fromDirection);
      },
      polygonColliderApply: function polygonColliderApply() {
        var manager = cc.director.getCollisionManager();
  ...
  double_boot: [ function(require, module, exports) {
    "use strict";
    ...
    double.LOCAL_VERSION_KEY = "LOCAL_VERSION_KEY";
    cc._RF.pop();
  }, {
    QrOption: "QrOption"
  } ],
  double_cell_newResult: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "e0c29KzPJlG74HzoR0JuaaG", "double_cell_newResult");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      onLoad: function onLoad() {},
      setRollTypeAndScale: function setRollTypeAndScale(type, lastIndex, endIndex) {
      ...
      setRollTime: function setRollTime(time, speed) {
      ...
      update: function update(dt) {
        ...
        if (this.bgY <= 0) {
          ...
          this.changeNumber++;
          this.changeNumber >= 3 && (this.changeNumber = 0);
          this.tempIndex = hall.GlobalFuncs.getRandomNumberBefore(this.lastIndex);
          this.animationTime--;
          0 == this.animationTime && (this.tempIndex = this.endIndex);
          if (0 == this.changeNumber) {
            this.objectType == double.windowNewWeaponType.newWeapon ? this.middleSprite.spriteFrame = this.gunSpriteFrameList[this.tempIndex] : this.middleSprite.spriteFrame = this.objectSpriteFrameList[this.tempIndex];
            this.middleLabel.string = double.GameWorld.objectConfig[double.GameWorld.doubleObjectList[this.tempIndex]].goldNumber;
          } else if (1 == this.changeNumber) {
            this.objectType == double.windowNewWeaponType.newWeapon ? this.topSprite.spriteFrame = this.gunSpriteFrameList[this.tempIndex] : this.topSprite.spriteFrame = this.objectSpriteFrameList[this.tempIndex];
            this.topLabel.string = double.GameWorld.objectConfig[double.GameWorld.doubleObjectList[this.tempIndex]].goldNumber;
          } else {
            this.objectType == double.windowNewWeaponType.newWeapon ? this.bottomSprite.spriteFrame = this.gunSpriteFrameList[this.tempIndex] : this.bottomSprite.spriteFrame = this.objectSpriteFrameList[this.tempIndex];
  ...
  double_cell_weaponsDepot: [ function(require, module, exports) {
    "use strict";
  ...
  double_gun: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "b19cctnBydA8YGHAHMMOMU4", "double_gun");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      changeGunType: function changeGunType(index) {
        if (0 == double.GameWorld.weaponType) {
      ...
      getGunAngle: function getGunAngle() {
        return this.scaleXMirror ? Math.PI - this.rotationNow : 2 * Math.PI - this.rotationNow;
      },
      changeGunRotation: function changeGunRotation() {
        ...
        if (this.scaleXMirror) {
          this.rotationNow < 0 ? this.rotationNow = -this.rotationNow : this.rotationNow = Math.PI - this.rotationNow;
          double.GameWorld.objectNowLocationY < this.locationY && (this.rotationNow += Math.PI);
        } else if (this.rotationNow < 0) {
        ...
        this.node.rotation = this.rotationNow / (2 * Math.PI) * 360;
      },
      update: function update(dt) {
  ...
  double_main: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "08ba1q9sxVL7qGxdEnvXpYv", "double_main");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      onLoad: function onLoad() {
        ...
        newer ? this.newerGameStart() : this.gameStart();
      ...
      chooseLevelObject: function chooseLevelObject() {
        ...
        if (double.GameWorld.newestObjectIndex <= 4) {
          for (i = 0; i < double.GameWorld.newestObjectIndex; i++) double.GameWorld.levelObjectList.push("object" + i);
          if (3 == double.GameWorld.newestObjectIndex) {
            if (5 == double.GameWorld.totalLevel) {
          ...
          } else 2 == double.GameWorld.newestObjectIndex && 2 == double.GameWorld.totalLevel && double.GameWorld.levelObjectList.push("object" + hall.GlobalFuncs.getRandomNumberBefore(3));
        } else {
          ...
          while (double.GameWorld.levelObjectList.length < 5) {
            ...
            addNumber = tempNumber > 1 - double.GameWorld.generalConfig.objectStageTopProbability ? hall.GlobalFuncs.getRandomNumberBefore(double.GameWorld.newestObjectIndex - middleIndex + 1) + middleIndex : tempNumber > 1 - double.GameWorld.generalConfig.objectStageTopProbability - double.GameWorld.generalConfig.objectStageMiddleProbability ? hall.GlobalFuncs.getRandomNumberBefore(middleIndex - bottomIndex + 1) + bottomIndex : hall.GlobalFuncs.getRandomNumberBefore(bottomIndex + 1);
            tempObject = "object" + addNumber;
            -1 == double.GameWorld.levelObjectList.indexOf(tempObject) && double.GameWorld.levelObjectList.push("object" + addNumber);
          }
        }
        var boxNowConfig;
        var subIndex;
        ...
        for (i = 0; i < this.levelProgressSpriteList.length; i++) {
          ...
          double.GameWorld.levelObjectList.length < 5 && 4 == i && (this.levelProgressSpriteList[i].node.active = false);
          double.GameWorld.levelObjectList.length < 4 && 3 == i && (this.levelProgressSpriteList[i].node.active = false);
        }
      },
      getNextObjectType: function getNextObjectType() {
        ...
        double.GameWorld.totalLevel >= 16 ? double.GameWorld.objectBlood = hall.GlobalFuncs.getRandomNumberBefore(bloodList[1] - bloodList[0] + 1) + bloodList[0] : 1 == double.GameWorld.totalLevel ? double.GameWorld.objectBlood = bloodList[3] : double.GameWorld.objectBlood = hall.GlobalFuncs.getRandomNumberBefore(5) - 2 + parseInt(double.GameWorld.totalLevel / 15 * (bloodList[3] - bloodList[2]) + bloodList[2]);
      ...
      openFireLeftButtonTouchEnded: function openFireLeftButtonTouchEnded() {
        if (double.GameWorld.gameOver || double.GameWorld.gamePause || double.GameWorld.gameLevelUp) return;
      ...
      receiveArrow: function receiveArrow() {
        ...
        } else this.progressNodeSprite.fillRange = double.GameWorld.objectBlood / this.objectBloodAll;
      },
      ...
      levelNumberUp: function levelNumberUp() {
        ...
        double.GameWorld.levelObjectNumber <= 0 ? this.levelUp() : this.getNextObjectType();
      },
      levelUp: function levelUp() {
        ...
        double.GameWorld.totalLevel % 10 == 1 ? double.GlobalFuncs.showRewardWeapon() : double.GlobalFuncs.showNewResult();
      },
      gameOver: function gameOver() {
        this.objectWin.removeAllGunHitAniNodeChild();
        double.GameWorld.gameOver = true;
        5 == double.GameWorld.levelObjectNumber ? double.GlobalFuncs.showGameOverResult() : double.GlobalFuncs.showResurgence();
      },
  ...
  double_newResult: [ function(require, module, exports) {
    "use strict";
    ...
    cc.Class({
      ...
      endRollAnimation: function endRollAnimation(rollType) {
        if (rollType < double.windowNewWeaponType.newResultRollOne) return;
        if (!this.isStartAni) {
          this.isStartAni = true;
        ...
        rollType == double.windowNewWeaponType.newResultRollOne ? this.coinNumber += double.GameWorld.objectConfig[double.GameWorld.doubleObjectList[this.resultIndex1]].goldNumber : rollType == double.windowNewWeaponType.newResultRollTwo ? this.coinNumber += double.GameWorld.objectConfig[double.GameWorld.doubleObjectList[this.resultIndex2]].goldNumber : this.coinNumber += double.GameWorld.objectConfig[double.GameWorld.doubleObjectList[this.resultIndex3]].goldNumber;
        ...
        if (this.resultNumber >= 3) {
          this.isEndAni = true;
          var resultAdd = 1;
          this.resultIndex1 == this.resultIndex2 && this.resultIndex2 == this.resultIndex3 ? resultAdd = 3 : this.resultIndex1 != this.resultIndex2 && this.resultIndex2 != this.resultIndex3 || (resultAdd = 2);
          if (1 != resultAdd) {
  ...
  double_object: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "f763d7UteFLJ6XCI2+CALII", "double_object");
    "use strict";
    cc.Class({
      ctor: function ctor() {
      ...
      changeGunType: function changeGunType(index) {
        0 == double.GameWorld.weaponType ? this.arrowIndex = -1 : this.arrowIndex = index;
      },
      ...
      sendArrowForObject: function sendArrowForObject(from, direction) {
        var arrowNode;
        if (this.arrowPool.size() > 0) arrowNode = this.arrowPool.get(); else {
          arrowNode = cc.instantiate(this.arrowPrefab);
          arrowNode.parentScene = this;
        }
        arrowNode.x = 0;
        arrowNode.y = 0;
        from ? this.rightArrowNode.addChild(arrowNode) : this.leftArrowNode.addChild(arrowNode);
        -1 == this.arrowIndex ? arrowNode.getComponent("double_arrow").reSetArrowSprite(this.gunSpriteFrame) : arrowNode.getComponent("double_arrow").reSetArrowSprite(this.arrowSpriteFrameList[this.arrowIndex]);
      ...
      receiveArrow: function receiveArrow(arrowNode, direction, from) {
        ...
        var vec1;
        vec1 = from ? this.gunHitAniNode.convertToNodeSpace(this.rightArrowNode.convertToWorldSpace(arrowNode.position)) : this.gunHitAniNode.convertToNodeSpace(this.leftArrowNode.convertToWorldSpace(arrowNode.position));
        arrowNode.x = vec1.x;
        arrowNode.y = vec1.y;
      ...
      playAddScoreAnimation: function playAddScoreAnimation(from) {
        var addNode;
        addNode = this.addScorePool.size() > 0 ? this.addScorePool.get() : cc.instantiate(this.addScorePrefab);
        addNode.getComponent("addScore").changeLabel();
        from ? this.rightAddScoreNode.addChild(addNode) : this.leftAddScoreNode.addChild(addNode);
      ...
      gameBomb: function gameBomb() {
        if ("box" == double.GameWorld.objectType) {
      ...
      update: function update(dt) {
        ...
        this.rotationNode.rotation = double.GameWorld.objectNowRotation;
        (double.GameWorld.objectNowLocationX < -this.windowWidth || double.GameWorld.objectNowLocationX > this.windowWidth || double.GameWorld.objectNowLocationY < -this.windowHeight || double.GameWorld.objectNowLocationY > this.windowHeight) && (double.GameWorld.gameLevelUp || this.gameOver());
      },
      onDestroy: function onDestroy() {
  ...
  double_pause: [ function(require, module, exports) {
    "use strict";
  ...
  double_rank: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "e69dd5hUAJH7L7kWe6lcG64", "double_rank");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      playAnimationAfterShareWithType: function playAnimationAfterShareWithType(shareType) {
        if (shareType && shareType != double.Share.onShareType.clickStatShareTypeRankList) return;
      ...
      showRankListForShare: function showRankListForShare() {
        ...
        if (!openDataContext) return;
        var sharedCanvas = openDataContext.canvas;
        this.shareTicket && "" != this.shareTicket ? double.GlobalFuncs.showGroupRank(this.shareTicket) : double.GlobalFuncs.showFriendRank();
        var texture = this.texture;
        var spriteFrame = this.spriteFrame;
        var sprite = this.rankSprite;
        var main = function main() {
      ...
      onStartButton: function onStartButton() {
        ...
        this.hideBackButton();
        var curScene = cc.director.getScene();
        if ("double_main" == curScene.name) ty.NotificationCenter.trigger(double.EventType.GAME_START, "start"); else {
  ...
  double_result: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "67eabQgCl5LlaIqSuS36Isq", "double_result");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
  ...
  double_res: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2385fSvZIpMU6hnAbtREiS8", "double_res");
    "use strict";
    double.EffectPath_mp3 = {
      gunHits: "/resources/sound/gundouble.mp3",
      gunHits0: "crazygun/sound/gundouble.mp3",
      gunHits1: "crazygun/sound/gundouble1.mp3",
      gunHits2: "crazygun/sound/gundouble2.mp3",
      ...
      gunHits9: "crazygun/sound/Gatling1.mp3",
      gunHits10: "crazygun/sound/Barrett.mp3"
    };
    double.weaponsPageCellType = {
      weaponBgBlue: "weaponBgBlue",
      weaponBgGreen: "weaponBgGreen",
      weaponBgYellow: "weaponBgYellow",
      weaponBgPink: "weaponBgPink",
      weaponBgWhite: "weaponBgWhite"
    };
    double.weaponsPageCellColor = {
      weaponBgBlue: cc.color(82, 222, 255, 1),
      weaponBgGreen: cc.color(114, 228, 106, 1),
      weaponBgYellow: cc.color(249, 217, 58, 1),
      weaponBgPink: cc.color(240, 118, 221, 1),
      weaponBgWhite: cc.color(255, 255, 255, 1)
    };
    cc._RF.pop();
  }, {} ],
  double_resurgence: [ function(require, module, exports) {
    "use strict";
  ...
  double_rewardWeapon: [ function(require, module, exports) {
    "use strict";
    ...
    cc.Class({
      ...
      startAnimation: function startAnimation() {
        if (this.isStartAni) this.isEndAni && this.node.destroy(); else {
          this.isStartAni = true;
      ...
      stopAnimation: function stopAnimation(aniType) {
        if (aniType != double.windowNewWeaponType.newWeapon) return;
        if (this.isStartAni) {
          this.startAnimation();
          return;
        }
  ...
  double_titlePage: [ function(require, module, exports) {
    "use strict";
  ...
  double_toast_tips: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "d1a73irOxBKl538u4pfix9q", "double_toast_tips");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      setTitleWithString: function setTitleWithString(titleString, time) {
  ...
  double_userInfo: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "8b8b321maNKdJWdRU0NLuEO", "double_userInfo");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {}
  ...
  double_weaponsDepot: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "c1657EOHvZHxZKAYM2l+RFe", "double_weaponsDepot");
    "use strict";
    cc.Class({
      extends: cc.Component,
      properties: {
      ...
      onLoad: function onLoad() {
        ...
        for (var i = 0; i < pages; i++) {
          pageView = pages[i];
          tempColor = 0 == i ? double.weaponsPageCellColor.weaponBgGreen : 1 == i ? double.weaponsPageCellColor.weaponBgYellow : double.weaponsPageCellColor.weaponBgPink;
          for (var j = 0; j < 12; j++) {
            ...
            addWindow.y = 249 - 166 * parseInt(j / 3);
      ...
      updateWeaponsDepotInfo: function updateWeaponsDepotInfo() {
        ...
        for (var i = 0; i < pages; i++) {
          pageView = pages[i];
          for (var j = 0; j < 12; j++) var addWindow = cc.instantiate(this.pageCellPrefab);
        }
      },
  ...
  double_window_newWeapon: [ function(require, module, exports) {
    "use strict";
    ...
    cc.Class({
      ...
      onClickOpen: function onClickOpen() {
        "open" == this.openType ? this.openBox() : double.Share.shareWithType(double.Share.onShareType.clickStatShareTypeAddBullet);
      },
  ...
  game_world: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "d3c58pTAlZIgqkP8Sp0sAmY", "game_world");
    "use strict";
    double.GameWorld = {
      gameOver: true,
      gamePause: false,
      ...
      generalConfig: {
        objectStageBottomProbability: .1,
        objectStageMiddleProbability: .4,
        objectStageTopProbability: .5,
        objectStageBottomScale: .25,
        objectStageMiddleScale: .5,
        objectStageTopScale: .25,
        gunUnlockChip: 250,
        bowUnlockChip: 500,
        stageOneLevel: 30,
        stageTwoLevel: 100
  ...
  sxAdManager: [ function(require, module, exports) {
    ...
    double.sxAdmanager = {
      ...
      show: function show(dx, dy, scale) {
        try {
          if (this.adIcon) {
            ...
            0 == dx && 0 == dy ? this.setPositionByScene(0) : this.adIcon.position = cc.v2(dx, dy);
            ...
            var callback = function callback() {
              ...
              0 == dx && 0 == dy && that.setPositionByScene(0);
              scale && (that.adIcon.scale = scale);
      ...
      setPosition: function setPosition(dx, dy) {
        this.adIcon && (this.adIcon.position = cc.v2(cc.winSize.width - dx, dy));
      },
      ...
      switchIcon: function switchIcon() {
        try {
          ...
          if (-1 != this.iconIndex && this.iconIndex != this.preIconIndex) {
      ...
      loadStaticImg: function loadStaticImg(arr) {
        ...
        cc.loader.load(link, function(err, tex) {
          self.adIcon.getComponent(cc.Sprite) ? self.adIcon.getComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame(tex) : self.adIcon.addComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame(tex);
        });
      },
      loadDynamicImg: function loadDynamicImg(arr) {
        ...
        cc.loader.load(link, function(err, results) {
          if (err) for (var i = 0; i < err.length; i++) hall.LOGW("sxAdManager: ", "load Dynamic img failed" + err[i] + "]: " + results.getError(err[i])); else {
...
}, {}, [ "double_main", "addScore", "double_arrow", "double_cell_newResult", "double_cell_weaponsDepot", "double_gun", "double_object", "double_toast_tips", "debugNode", "double_newResult", "double_pause", "double_rank", "double_result", "double_resurgence", "double_rewardWeapon", "double_titlePage", "double_weaponsDepot", "double_window_newWeapon", "BiLog", "EventType", "HttpUtil", "MsgCache", "NotificationCenter", "ServerStateManager", "Share", "SystemInfo", "TCP", "Timer", "TuyooSDK", "UserInfo", "QrOption", "ServerManager", "doubleAudioHelper", "doubleEventType", "doubleGlobalFuncs", "double_boot", "double_res", "game_world", "GameModel", "double_userInfo", "doubleNetWorkCenter", "sxAdManager", "GlobalFuncs", "HallGameWorld", "HallNetWorkCenter", "MsgFactory", "PropagateInterface", "boot", "HallUserInfo", "TodoTask", "TodoTaskVec", "UserInfoUData", "AdManager", "GlobalTimer", "MsgBoxManager", "ToDoTasks" ]);