...
// 按钮缩放,放大特效
// 按钮特效 scale 缩放大小
hall.GlobalFuncs.btnScaleEffectGold = function (node){
	node.stopAllActions();
	var scale_1 = cc.scaleTo(0, 1.5, 1.5);
	var scale_2 = cc.scaleTo(0.2, 0.8, 0.8);
	var scale_3 = cc.scaleTo(0.2, 1, 1);
	var scale_4 = cc.scaleTo(0.2, 0.8, 0.8);
	var scale_5 = cc.scaleTo(0.2, 1,1);
	var seq1 = cc.sequence(scale_1, scale_2,scale_3, scale_4,scale_5);
	node.runAction(seq1);
};
// 按钮缩放,放大特效
// 按钮特效 scale 缩放大小
hall.GlobalFuncs.btnScaleEffectLeft = function (node,scale){
	node.stopAllActions();
	var scale_1 = cc.scaleTo(0.2, scale, scale);
	var scale_2 = cc.scaleTo(0.2, 1, 1);
...
// 按钮缩放,放大特效
// 按钮特效 scale 缩放大小
hall.GlobalFuncs.btnScaleEffectRight = function (node,scale){
	node.stopAllActions();
	var scale_1 = cc.scaleTo(0.2, scale, scale);
	var scale_2 = cc.scaleTo(0.2, 1, 1);
	var seq1 = cc.sequence(scale_2,scale_1);
	node.runAction(seq1.repeatForever());
};
// 按钮缩放,放大特效
// 按钮特效 scale 缩放大小
...
// 按钮缩放,放大特效
// 按钮特效 scale 缩放大小
hall.GlobalFuncs.btnScaleEffectForNewResult = function (node){
	node.stopAllActions();
	var scale_1 = cc.scaleTo(0.2, 1.5, 1.5);
	var scale_2 = cc.scaleTo(0.2, 0.8, 0.8);
	var scale_3 = cc.scaleTo(0.2, 1, 1);
	var scale_4 = cc.scaleTo(0.2, 0.8, 0.8);
	var scale_5 = cc.scaleTo(0.2, 1, 1);
...
hall.GlobalFuncs.nodeActiveChangeEffect = function (node){
	node.stopAllActions();
	var scale_1 = cc.fadeOut(0.1);
	var scale_2 = cc.fadeIn(0.1);
	// var delay = cc.delayTime(1.3);
	var seq1 = cc.sequence(scale_2, scale_1);
	// var ac = cc.repeat(seq1,15);
	// node.runAction(ac);
	node.runAction(seq1.repeatForever());
};
//黄色
hall.GlobalFuncs.nodeColorChangeEffect = function (node){
	node.stopAllActions();
	var scale_1 = cc.tintTo(0.1,253,221,0);
	var scale_2 = cc.tintTo(0.1,255,255,255);
	var seq1 = cc.sequence(scale_1, scale_2);
	// var ac = cc.repeat(seq1,15);
	// node.runAction(ac);
	node.runAction(seq1.repeatForever());
...
//蓝色
hall.GlobalFuncs.nodeColorChangeEffect2 = function (node){
	node.stopAllActions();
	var scale_1 = cc.tintTo(0.1,82,222,255);
	var scale_2 = cc.tintTo(0.1,255,255,255);
	var seq1 = cc.sequence(scale_2, scale_1);
	var ac = cc.repeat(seq1,5);
	node.runAction(ac);
};
//绿色
hall.GlobalFuncs.nodeColorChangeEffect3 = function (node){
	node.stopAllActions();
	var scale_3 = cc.scaleTo(0.02, 1.3, 1.3);
	var scale_2 = cc.tintTo(0.05,255,255,255);
	var scale_1 = cc.tintTo(0.03,114,228,106);
	var scale_4 = cc.scaleTo(0.01, 1, 1);
	var seq1 = cc.sequence(scale_3,scale_2, scale_1,scale_4);
	// var ac = cc.repeat(seq1,5);
	node.runAction(seq1);
};
//黄色
hall.GlobalFuncs.nodeColorChangeEffect4 = function (node){
	node.stopAllActions();
	var scale_3 = cc.scaleTo(0.02, 1.3, 1.3);
	var scale_2 = cc.tintTo(0.05,255,255,255);
	var scale_1 = cc.tintTo(0.03,249,217,58);
	var scale_4 = cc.scaleTo(0.01, 1, 1);
	var seq1 = cc.sequence(scale_3,scale_2, scale_1,scale_4);
	// var ac = cc.repeat(seq1,5);
	node.runAction(seq1);
