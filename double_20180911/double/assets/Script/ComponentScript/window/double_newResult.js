...
cc.Class({
    ...
    changeCheckState : function () {
        ...
        if(this.openType.indexOf("checkBox") > -1) {
            this.openType = "share";
            //金币老虎机无复选框
        }else if(this.openType == "shareClick"){
            this.openType = "share";
        }
    },
    ...
    getMoreCoinAction : function () {
        ...
        if(this.openType == "share") {
            ...
            hall.adManager.showRewardedVideo("chipMachine");
        }else {
            this.topButton.node.active = false;
            this.getChipForStart();
        }
    ...
    rewardVideoComplete : function(isEnd){
        if(hall.adManager.rewardedVideoType != "chipMachine"){
            return;
        }
        if(isEnd){
            this.getMoreCoinResult();
    ...
    getCoinAction : function () {
        if(this.isEndAni){
            ...
            if(this.originOpenType == "shareClick"){
                double.GlobalFuncs.changeShareState("chipMachine");
            }
        }
    },
    ...
    getChipForStart : function () {
        ...
        animation.once("finished", function (target) {
            ...
            if(double.GameWorld.totalLevel%10 == 1 && double.GameWorld.totalLevel < 100){
                // 每10关，进行枪械转盘抽奖励
                hall.adManager.showBannerAd(true);
