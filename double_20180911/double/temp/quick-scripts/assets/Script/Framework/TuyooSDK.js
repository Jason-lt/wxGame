(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/Framework/TuyooSDK.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '2a1ff3UaalGCL32rrcdlLsh', 'TuyooSDK', __filename);
// Script/Framework/TuyooSDK.js
...
ty.TuyooSDK = {
    ...
    //                                 },
    //                                 fail:function () {
    //                                     ty.NotificationCenter.trigger(double.EventType.START_AUTHORIZATION_FAILED);
    ...
    wechatLoginDirect: function wechatLoginDirect(loginCode) {
        ty.ServerStateManager.checkServerState(function () {
            ...
            //     double.GlobalFuncs.getUserInfo();
    ...
    loginTuyooWithCode: function loginTuyooWithCode(code, userInfo, iv, encryptedData) {
        ...
        // double.Share.shareKeywordReplace.wechatName = userInfo.nickName;
    ...
    //             ty.Timer.cancelTimer(cc.director, checkUserInfo);
    //             double.GameWorld.game_friendData = context['game_friendData'];
    //
    //         }
    //     };
    //     ty.Timer.setTimer(cc.director, checkUserInfo, 1 / 60);
...
wx.onShow(function (result) {
    ...
    if (query && query.gdt_vid && query.weixinadinfo) {
        ...
        //从小程序消息卡片中点入
        ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeUserFrom, [scene, query.inviteCode, double.Share.clickStatShareType[query.sourceCode], query.imageType, "CardActive", JSON.stringify(result)]);
    } else {
        ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeUserFrom, [scene, query.from, query.appid, "CardActive", JSON.stringify(result)]);
    }

    if (query && query.sourceCode) {
        //从小程序消息卡片中点入
        if (query.sourceCode == double.Share.onShareType.clickStatShareTypeRankList && scene == 1044) {
            //群排行榜
    ...
    // if(double.Share.isOnShare && ty.UserInfo.userId){
