(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/hall/utils/AdManager.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '33124y9QPBMrJgxISvLKBIE', 'AdManager', __filename);
// Script/hall/utils/AdManager.js
...
hall.adManager = {
    ...
    showRewardedVideo: function showRewardedVideo(type) {
        ...
        var onvVdClose = function onvVdClose(res) {
            ...
            if (!playEnded) {
                ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeWatchVideo, ["noComplete", type]);
            } else {
