(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/ComponentScript/window/ddz_tipsWindow.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '776cfqTURtAvahetqtdOl1M', 'ddz_tipsWindow', __filename);
// Script/ComponentScript/window/ddz_tipsWindow.js
...
cc.Class({
    ...
    completeAni: function completeAni() {
        if (this.clickType == 1) {
            ...
            if (this.parentScene) {
                if (this.parentScene.tipsOnClose) {
                    this.parentScene.tipsOnClose();
                }
            }
        }
    ...
    setDissolvePregrossForAnswer: function setDissolvePregrossForAnswer(lossTime, progress, name) {
        ...
        var progressManager = this.progressNode.getComponent('ddz_item_tipswindow_progress');
        progressManager.setDissolvePregross(progress);
        var testArray = [{ title: "解散(" + this.lossTime + "s)" }, { title: "不解散" }];
        var buttonManager = this.buttonListNode.getComponent('ddz_item_tipsWindow_buttonNode');
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_tipsWindow.js.map
