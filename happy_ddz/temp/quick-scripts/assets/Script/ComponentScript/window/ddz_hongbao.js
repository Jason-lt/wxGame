(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/ComponentScript/window/ddz_hongbao.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '46c68NQcxZP9YPkcqFxsxne', 'ddz_hongbao', __filename);
// Script/ComponentScript/window/ddz_hongbao.js
...
cc.Class({
    ...
    playAnimationAfterShareWithType: function playAnimationAfterShareWithType(shareType) {
        ...
        if (shareType != ddz.Share.onShareType.clickStatShareTypeMainTips && shareType != ddz.Share.onShareType.clickStatShareTypeWithChip) {
            return;
        }
    ...
    updateButtonText: function updateButtonText(data) {
        if (data.pointId != ddz.Share.SharePointType.lottery || data.pointId != ddz.Share.SharePointType.withChip) {
            return;
        }
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_hongbao.js.map
