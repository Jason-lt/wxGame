(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/ComponentScript/Scenes/ddz_reward.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'cbe2erGtLtEYZc71t/H+Nkh', 'ddz_reward', __filename);
// Script/ComponentScript/Scenes/ddz_reward.js
...
cc.Class({
    ...
    addTipsAssets: function addTipsAssets(tips) {
        ...
        hall.GlobalFuncs.showPopWinByPreFab(preFabPath, function (preFabNode) {
            var window = preFabNode.getComponent(comName);
            window.setTitleContentAndButtonsString("提示", "<color=#1A6951>" + tips + "</c>", [{ title: "确定", callFunc: function callFunc() {} }]);
        });
    },
    ...
    onDrawButton: function onDrawButton() {
        ...
        if (draw.drawMoeyString.indexOf(".") > 0) {
            ...
            if (arr[1] && arr[1] > 0) {
                ...
                hall.GlobalFuncs.showPopWinByPreFab(preFabPath, function (preFabNode) {
                    var window = preFabNode.getComponent(comName);
                    window.setTitleContentAndButtonsString("提示", "<color=#1A6951>" + tips + "</c>", [{ title: "取消", callFunc: function callFunc() {} }, { title: "提现", callFunc: function callFunc() {
    ...
    onConversionButton: function onConversionButton() {
        ...
        hall.GlobalFuncs.showPopWinByPreFab(preFabPath, function (preFabNode) {
            ...
            window.setTitleContentAndButtonsString("提示", "<color=#1A6951>" + tipsString + "</c>", [{ title: "取消", callFunc: function callFunc() {} }, { title: "兑换", callFunc: function callFunc() {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddz_reward.js.map
