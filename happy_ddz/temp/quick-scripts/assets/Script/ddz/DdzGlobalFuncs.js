(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/ddz/DdzGlobalFuncs.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'dfb06LdRwJG0554aS1NJuJM', 'DdzGlobalFuncs', __filename);
// Script/ddz/DdzGlobalFuncs.js
...
ddz.GlobalFuncs.getBannerIntervalY = function () {
	var systemTy = ty.UserInfo.systemType;
	var reultHeight = 0;
	if (systemTy == ty.UserInfo.SYSTEMTYPE.iPhoneXType) {
		//iPhoneX
		reultHeight = 20;
	}
	return reultHeight;
...
ddz.GlobalFuncs.getMainInterY = function () {
	...
	if (systemTy == ty.UserInfo.SYSTEMTYPE.iPhoneXType || size.height / size.width >= 2) {
		//iPhoneX
		reultHeight = -102;
	}
	return reultHeight;
...
ddz.GlobalFuncs.showTipsWindowWithString = function (widthTips, buttonS) {
	...
	hall.GlobalFuncs.showPopWinByPreFab(preFabPath, function (preFabNode) {
		...
		window.setTitleContentAndButtonsString("提示", widthTips, [{ title: tiString, callFunc: function callFunc() {} }]);
	});
};
...
cc._RF.pop();
        ...
        //# sourceMappingURL=DdzGlobalFuncs.js.map
