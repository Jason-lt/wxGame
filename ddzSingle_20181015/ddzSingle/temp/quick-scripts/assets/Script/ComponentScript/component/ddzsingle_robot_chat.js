(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/ComponentScript/component/ddzsingle_robot_chat.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '1ee1fCRQtlE1p2RTIk2JvsX', 'ddzsingle_robot_chat', __filename);
// Script/ComponentScript/component/ddzsingle_robot_chat.js
...
ddz.AIChat = cc.Class({
	...
	setDizuPlayer: function setDizuPlayer(val) {
		this._dizhuPlayer = [];
		if (val) {
	...
	setNontminPlayer: function setNontminPlayer() {
		this._nongminPlayer = [];
	...
	startUrgeTimer: function startUrgeTimer() {
		ty.Timer.setTimer(this, this._urgeTalk, 38, cc.REPEAT_FOREVER, 0);
	},

	stopUrgeTimer: function stopUrgeTimer() {
	...
	// 平常出牌的话语
	commonPlayTalk: function commonPlayTalk(playerController) {
		if (!this._isIn(1 / 8)) {
			return;
		}
	...
	// 炸弹出牌说话
	bombPlayTalk: function bombPlayTalk(playerController) {
		if (!this._isIn(1 / 2)) {
			return;
		}
	...
	// 玩家使用炸弹后的处理
	playerUseBomb: function playerUseBomb() {
		if (!this._isIn(1 / 3)) {
			return false;
		}
	...
	_cpuIsFriendWhenPlayerUseBomb: function _cpuIsFriendWhenPlayerUseBomb(playerController) {
		if (!playerController) {
			return false;
		}
	...
	// 电脑是我的敌人
	_cpuIsEnemyWhenPlayerUseBomb: function _cpuIsEnemyWhenPlayerUseBomb(playerController, res) {
		if (!playerController) {
			return false;
		}
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddzsingle_robot_chat.js.map
