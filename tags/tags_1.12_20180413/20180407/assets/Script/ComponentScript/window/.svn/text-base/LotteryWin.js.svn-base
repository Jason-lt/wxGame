...
cc.Class({
    ...
    onOK:function () {
        ddz.GameWorld.shareKeywordReplace.lastBonusOnly = this.money;
        ddz.GameWorld.shareKeywordReplace.lastWinnerCount = this.count;
        var shareType = ty.UserInfo.clickStatShareType.clickStatShareTypeMainTips;
        ty.TuyooSDK.shareWithType(shareType,function () {
