...
ty.UserInfo = {
    ...
    clickStatEventType :{
        clickStatEventTypeShareSuccess : 67890000,//分享成功(非邀请好友)
        clickStatEventTypeOnClickButton : 67890001,//点击分享按钮(非邀请好友)
        clickStatEventTypeClickFromCardStart : 67890002,//从分享卡片进入作为启动(新人或从关闭状态打开)
        clickStatEventTypeClickFromCardActive : 67890003,//从分享卡片进入(激活)(非邀请好友)
        clickStatEventTypeClickFromOther : 67890004,//从非分享卡片进入(启动&激活)
