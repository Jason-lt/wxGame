...
cc.Class({
    ...
    onLoad: function () {
        ...
        if (!ty.UserInfo.userId){
            ...
            if(debugMode){
                var window = this.getComponent("Ddz");
    ...
    changeEnterBtnState:function (_stageIndex) {
        // hall.LOGE("","file = [Ddz] fun = [changeEnterBtnState] _stageIndex = " + _stageIndex);
        // hall.LOGE("","file = [Ddz] fun = [changeEnterBtnState] ddz.matchModel.showBack() = " + ddz.matchModel.showBack());
