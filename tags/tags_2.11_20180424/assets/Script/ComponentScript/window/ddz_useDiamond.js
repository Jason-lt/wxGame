    ...
    setDetailWithDiamondCount:function(type,state,guan){
        ...
        if (this.sceneType == 1){
            ...
            this.detailText.string =
                ...
                "<img src='dda_button_diamond' height=38 width=44/><size='36' color=#fffffff> +1</color><br/>"+
                "<img src='ddz_white_circle' height= 8 width=8 /><color=#ffffff> 邀请朋友每天第一次登录得 </color>" +
                "<img src='dda_button_diamond' height=38 width=44/><size='36' color=#fffffff> +1</color>";
        ...
        if(isHasCount){
            ...
            this.coutLabel.string = "<color=#ffffff>已有：</c><img src='dda_button_diamond'/><color=#ffffff> +"+this.diamondCount+"</color>";
        }else {
