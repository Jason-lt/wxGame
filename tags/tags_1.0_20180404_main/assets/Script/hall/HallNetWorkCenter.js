...
hall.hallNetWorkCenter = {
    ...
    onUserInfo: function(argument) {
        ...
        if(scene == 1044 || scene == 1007 || scene == 1008|| scene == 1036) {
            ...
            if (shareTicket && !this.onQuickStart) {
                ty.SystemInfo.shareTicket = shareTicket;
            }
        }
        if(ty.SystemInfo.shareTicket != "" && !this.onQuickStart){
        ...
        // {"scene":"1044","query":{"name":"rank"},"shareTicket":"ca75a1c3-c986-4257-a201-3025ef69d97e"}
