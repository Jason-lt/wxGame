...
ty.TuyooSDK = {
    ...
    shareToGetDiamond : function () {
        ...
        ty.TuyooSDK.shareWithTitleArrayAndImageArray(titleA,imageA,query);
    },
    shareWithTitleArrayAndImageArray : function (titleArray,imageArray,query) {
        ...
        ty.TuyooSDK.shareWithInformation(titleArray[titleNumber],imageArray[imageNumber],query);
    },
    shareWithInformation : function (titleString,imagUrl,query) {
        hall.LOGD(null, "shareWithInformation+++++++++++++++++"+titleString+"+++++++++++++++++"+imagUrl);
        wx.shareAppMessage({
            title: titleString,
...
wx.onShow(function (result) {
    ...
    hall.LOGE('', "++++++++onShow+++++++++"+JSON.stringify(arguments));
    hall.onHide = false;
...
wx.onShareAppMessage(function (result) {
    ...
    var imageA = ddz.GameWorld.shareImageList.shareButton;
    var imageCount = hall.GlobalFuncs.getRandomNumberBefore(imageA.length);
    return {
        title: titleA[titleCount],
        imageUrl:imageA[imageCount],
        success : function (shareTickets,groupMsgInfos) {
            hall.LOGD(null, "onShareAppMessage+++++++++++++++++"+JSON.stringify(shareTickets)+"+++++++++++++++++"+groupMsgInfos);
        },
        fail : function () {
            hall.LOGD(null, JSON.stringify(arguments));
        },
