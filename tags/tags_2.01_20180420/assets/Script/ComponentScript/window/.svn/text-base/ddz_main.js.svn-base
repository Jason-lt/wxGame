...
cc.Class({
    ...
    onLoad :function () {
        ...
        this.rewardDes = hall.GlobalFuncs.ReadStringFromLocalStorage(ddz.matchModel.MATCH_REWARD_DES, "奖金");
        ...
        this.tipsButton.node.y = backButtonH;
    ...
    onTipsButton : function () {
        for (var i = 0; i < this.inviteeList.length; i ++){
            ...
            ddz.gameModel.getInviteReward(inviteeId);
        }
