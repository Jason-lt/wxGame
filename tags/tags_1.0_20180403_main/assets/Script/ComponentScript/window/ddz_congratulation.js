    ...
    setMcountDetail:function (mcountList) {
        ...
        for (var i = 0 ; i < mcountList.length ; i ++){
            ...
            if(reward.icon == "user:coupon"){
                richString = richString + "<color=#ffffff>、￥</color>" +"<color=#ffffff>"+reward.count/100+"</c>";
                haveS = true;
            }
        }
        if (haveS){
            richString = richString + "<br/><color=#ffffff>平分奖金将于今晚24:00发放</color>";
        }else {
            richString = "<br/><color=#ffffff>平分奖金将于今晚24：00发放</color>";
            this.rewardRichText.height = 200;
        }
