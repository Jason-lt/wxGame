...
hall.hallNetWorkCenter = {
    ...
    _onLocInfo: function (larr) {
        ...
        if(query && query.sourceCode){
            ...
            //         query.sourceCode == ddz.Share.onShareType.clickStatShareTypeRankList && scene == 1044) {
            ...
            if (curDay != lastDay && query.inviteName && query.sourceCode != ddz.Share.onShareType.clickStatShareTypeInviteFriend) {
        ...
        if (roomid != 0 && tableid != 0) {
            ...
            if(ty.SystemInfo.shareTicket != "" ){
                ...
                if (!ddz.matchResultPanel && !ddz.matchResultPanel2){
    ...
    onReceiveGameData : function(value){
        hall.LOGE(null, "file = [HallNetWorkCenter] fun = [onReceiveGameData] ");
    ...
    onProdDelivery: function(params) {
        hall.LOGE("","file = [HallNetWorkCenter] fun = [onProdDelivery] params = " + JSON.stringify(params));
