...
cc.Class({
    ...
    playAnimationAfterShareWithType : function (shareType) {
        hall.LOGW("=="," file = [LotteryWin] fun = [playAnimationAfterShareWithType] ");
    ...
    getDiamond:function(){
        hall.LOGW("=="," file = [LotteryWin] fun = [getDiamond] ");
        ddz.GlobalFuncs.playZuanShi(true);
    },

    updateButtonText:function(data){
        hall.LOGW("=="," file = [LotteryWin] fun = [updateButtonText] diamond = " + data.leftCount);
        if (data.pointId != ddz.Share.SharePointType.lottery){
            return;
        }
        // this.txtLabel.string = "<color=#FFFFFF>分享</c>";
