...
ddz.Share = {
    ...
    shareImformation : function (type,imageType,titleString, imagUrl,query,sharePoint,successCallBackFun,failCallBackFun) {
        ...
        ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeUserFrom,[null,null,null,
            "ClickButton",type,imageType,ty.UserInfo.userId]);
        ...
        wx.shareAppMessage({
            ...
            success : function (result) {
                ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeUserFrom,[null,null,null,
                    "ShareSuccess",type,imageType,ty.UserInfo.userId]);
                if(type == ddz.Share.clickStatShareType.clickStatShareTypeInviteFriend){
    ...
    getShareTicketInformation : function (result) {
        ...
        if(ddz.Share.shareType != ddz.Share.clickStatShareType.clickStatShareTypeRevial){
    ...
    playAnimationAfterShareWithType : function () {
        ...
        if(ddz.Share.shareType == ddz.Share.clickStatShareType.clickStatShareTypeRankList){
...
wx.onShareAppMessage(function (result) {
    ...
    ddz.Share.isOnShare = true;
    ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeUserFrom,[null,null,null,
        "ClickButton",type,imageMap.imageType,ty.UserInfo.userId]);
    ...
    return {
        ...
        success : function (shareTickets,groupMsgInfos) {
            ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeUserFrom,[null,null,null,
                "ShareSuccess",type,imageMap.imageType,ty.UserInfo.userId]);
