...
cc.Class({
    ...
    setDetailWithDiamondCount:function(type,state,guan){
        ...
        if (this.sceneType == 1){
            ...
            this.detailText.string =
                "<img src='ddz_white_circle' height=8 width=8/><color=#ffffff> 闯过七关可平分每日奖励</color><br/>" +
                ...
                "<img src='ddz_white_circle' height= 8 width=8 /><color=#ffffff> 邀请朋友每天首次登录得 </color>" +
    ...
    onTopButtonAction : function () {
        ...
        if (this.sceneType == 1){//活动详情---闯关
            ...
            var titleA = ["快来帮帮我，我和现金奖励的距离就差一个你！",
                "闯关赢现金，我需要你的援手！",
                "我正在闯关赢现金，快来帮帮我！"];
