...
cc.Class({
    ...
    initWithPar:function (bLeft, bTop, playContrl) {
        this._bLeft = bLeft;
        this._bTop = bTop;
    ...
    _addCardsIntoContainer: function(cardNums, bSort, bDizhu) { //bSort表明牌是否需要排序，出牌时不需要，展示牌时需要
    ...
    showTimer:function (valTime) {
        ...
        this.lblTimer.string = this._leftTime +"";
    ...
    getIsMale:function () {
        return this._userInfo.m_sex == ddz.Enums.PlayerSexEnum.SEX_MALE;
    },
