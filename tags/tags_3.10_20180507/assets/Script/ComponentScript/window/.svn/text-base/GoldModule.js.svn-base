...
cc.Class({
    ...
    onLoad : function() {
        ...
        ty.NotificationCenter.listen(ddz.EventType.REMOVE_MATCHING, this.removeMatching, this);
        // this.startAni();
        // this.initScore();
    },
    startAni : function () {
    ...
    showResult:function (result) {
        ...
        this.scheduleOnce(function () {
            // ddz.GlobalFuncs.showShareGuideWindow(true,192,3);
            if(result.winShare){
                ddz.GlobalFuncs.showShareGuideWindow(true,result.winShare.winChip,result.winShare.rewardDoubles);
                ...
                ddz.GlobalFuncs.showShareGuideWindow(false,result.loseShare.loseChip,result.loseShare.rewardDoubles);
                ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeShowWindow,
