...
cc.Class({
    ...
    setShareCountRichText : function () {
        ...
        this.sahreRichText.string = "<color=#1A6951><size=36>分享到群（"+showCount+"/3）</size><br/><size=30>奖励：" +
            "<img src='dda_button_diamond_black' height=38 width=44/> +"+lossCount+"</size></color>";
    ...
    playAnimationAfterShareWithType : function () {
        ...
        switch (type) {
            case 1:
                ...
                break;
            case 2:
                ddz.GlobalFuncs.showTipsWindowWithString("这个群已经分享过啦，分享到其他群吧",this,"分享到其他群");
                break;
            case 3:
    ...
    changeDiamondCount : function () {
        ...
        this.haveCountRichText.string =
            "<color=#ffffff>已有：</c><img src='dda_button_diamond' height=38 width=44/><color=#ffffff> x"+this.diamondCount+"</color>";
    },
    ...
    playAnimationAftergetReward : function (value) {
        ...
        this.aniRichText.string = "<img src='dda_button_diamond_black' height=38 width=44/><color=#1A6951> +"+value+"<c/>";
    ...
    updateRewardMassage : function () {
        ...
        //     "pic":"https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTIRYXHlGLzuup1W2T1S0J3xJmeJbvTEgpSD9oAHlPE3FC0BQvfyTKsqIicNzmfxZGyUFjMDeEO3vXA/0","rewardState":1,"bindRewardCount":1,"count":1,"nowCount":0},{"pic":"","rewardState":0,"count":2,"userId":0,"name":"玩家","nowCount":0,"bindRewardCount":1},{"pic":"","rewardState":0,"count":3,"userId":0,"name":"玩家","nowCount":0,"bindRewardCount":1},{"pic":"","rewardState":0,"count":4,"userId":0,"name":"玩家","nowCount":0,"bindRewardCount":1},{"pic":"","rewardState":0,"count":5,"userId":0,"name":"玩家","nowCount":0,"bindRewardCount":1},{"pic":"","rewardState":0,"count":6,"userId":0,"name":"玩家","nowCount":0,"bindRewardCount":2},{"pic":"","rewardState":0,"count":7,"userId":0,"name":"玩家","nowCount":0,"bindRewardCount":2},{"pic":"","rewardState":0,"count":8,"userId":0,"name":"玩家","nowCount":0,"bindRewardCount":2},{"pic":"","rewardState":0,"count":9,"userId":0,"name":"玩家","nowCount":0,"bindRewardCount":2},{"pic":"","rewardState":0,"count":10,"userId":0,"name":"玩家","nowCount":0,"bindRewardCount":2}];
