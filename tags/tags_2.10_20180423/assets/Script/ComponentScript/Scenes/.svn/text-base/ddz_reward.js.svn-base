...
cc.Class({
    ...
    onClickCenterButton:function(){
        ddz.Share.shareWithType(ddz.Share.clickStatShareType.clickStatShareCash);
    },

    playAnimationAfterShareWithType : function (shareType) {
        if (shareType && shareType != ddz.Share.clickStatShareType.clickStatShareCash) {
            return;
        }
