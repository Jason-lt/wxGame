...
cc.Class({
    ...
    setDetailWithDiamondCount:function(type,state,guan){
        ...
        if (this.sceneType == 1){
            ...
            buttonA = [{title :titlS, left :'ddz_main_icon_begin_v2', bottomType :1}];
        ...
        if(isHasCount){
            ...
            this.coutLabel.string = "<color=#ffffff>已有：</c><img src='dda_button_diamond' height=34 width=42/><color=#ffffff> +"+this.diamondCount+"</color>";
        }else {
