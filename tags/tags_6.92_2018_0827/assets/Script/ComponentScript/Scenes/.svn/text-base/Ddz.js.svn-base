...
cc.Class({
    ...
    createCrossButton: function(){
        if(hall && hall.AdManagerTYWX){
            ...
            if (hall.AdManagerTYWX.getAdNodeList()[0]) {
                hall.AdManagerTYWX.getAdNodeList()[0].showAdNode();
            }else {
                hall.AdManagerTYWX.showAd({x:80,y:size.height/2},"myFirstAdNode");
            }
    ...
    onDestroy : function () {
        ...
        if (hall.AdManagerTYWX && hall.AdManagerTYWX.getAdNodeList()[0]) {
            hall.AdManagerTYWX.getAdNodeList()[0].hideAdNode();
        }
