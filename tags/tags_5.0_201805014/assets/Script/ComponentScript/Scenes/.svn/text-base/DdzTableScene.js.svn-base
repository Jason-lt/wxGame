...
cc.Class({
    ...
    getEmoPos: function(index){
        ...
        hall.LOGE("====","====getEmoPos=this.head_regiht.y===="+testY);
        var ttt = this.head_regiht.convertToWorldSpace(cc.p(0,0));
        var pos;
    ...
    toFriend:function () {
        if (!this._friendPanel && this.tableInfo().ftInfo){
    ...
    toArenaMatch:function() {
        ...
        if(this.tableInfo().getSceneType() == ddz.Enums.SceneType.ARENA) {
            this.stageTag.active = false;
            ...
            this._arenaPanelNode.parent = this.node;
        }
