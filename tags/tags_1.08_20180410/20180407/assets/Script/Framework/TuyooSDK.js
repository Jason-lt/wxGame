...
ty.TuyooSDK = {
    ...
    shareWithTitleArrayAndImageArray : function (titleArray,imageArray,tipsXXX,tipsN, callBackFun) {
        ...
        ty.TuyooSDK.shareWithInformation(titleArray[titleNumber],imageArray[imageNumber],tipsXXX, tipsN, callBackFun);
    },
    shareWithInformation : function (titleString, imagUrl , tipsXXX, tipsN, callBackFun) {
        if(tipsXXX){
