...
ddz.Share = {
        ...
        image.onload = function (event) {
            ...
            while (nowIndex < extraAdd.length) {
                ...
                if (extraMap.type == "text") {
                    ...
                    image.originPointX = parseInt(imageInformation.originPointX);
                    image.originPointY = parseInt(imageInformation.originPointY);
                    image.sizeWidth = parseInt(imageInformation.sizeWidth);
                    image.sizeHeight = parseInt(imageInformation.sizeHeight);
    ...
    shareImformation : function (type, shareCfg, titleString, imageUrl, query, sharePoint, successCallBackFun, failCallBackFun) {
        ...
        var imageType = sharePointId + "_" + shareSchemeId;
    ...
    clickStatShareType :{
        ...
        clickStatShareTypeSeekHelpFriend : 31,//求助好友开宝箱
        clickStatShareTypeCustomsSuccess : 32,//闯关成功分享
        clickStatShareTypeGetDiamondFailSix : 33,//第六关闯关失败分享
        clickStatShareTypeNewUserGifts : 34//新人限时宝箱
    },
    ...
    SharePointType:{
        ...
        firstUseJiPaiQi:67890020, //首次送记牌器
    ...
    shareConfig :{
        "share": {
            ...
            "clickStatShareTypeNewUserGifts": {
                "massageList": [{
                    "formatString": "新人限时宝箱"
                }],
                "imageList": [{
...
wx.onShareAppMessage(function (result) {
    ...
    if(shareDetail.query){
        var queryString = hall.GlobalFuncs.replaceKeyWordInString(shareDetail.query);
        query = "inviteCode=" + ty.UserInfo.userId+"&sourceCode=" + type + "&imageType=" + imageType + "&inviteName=" + ty.UserInfo.userName + "&" + queryString;
    }else {
        query = "inviteCode=" + ty.UserInfo.userId+"&sourceCode=" + type + "&imageType=" + imageType + "&inviteName=" + ty.UserInfo.userName;
    }
