...
cc._RF.push(module, '98521xzfURGVaqRPaKxuEHl', 'PropagateInterface', __filename);
...
ty.PropagateInterface = {
    ...
    * 获取用户分享价值*/
    getShareValueConfig: function getShareValueConfig() {
        ...
        var reqObj = {};
        reqObj.act = "api.getUserFeature";
        reqObj.time = parseInt(timeStamp / 1000);
        ...
        var successcb = function successcb(res) {
            ty.NotificationCenter.trigger(ty.EventType.GET_SHARE_VALUE_SUCCESS, res);
        };
