(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/hall/HallNetWorkCenter.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '6ab5eWt2qFOOocFil2B6RB4', 'HallNetWorkCenter', __filename);
...
hall.hallNetWorkCenter = {
    ...
    onReceiveTCP_Msg: function onReceiveTCP_Msg(value) {
        ...
        if (result) {
            ...
            if (gameId === ty.SystemInfo.hallId) {
                ...
                // store_config 特殊处理下,大厅共用,此消息没有传gameId
                var func = this.cmdMap[msgCmd];
                if (func) {
                    func.call(this, value);
                } else {
    ...
    _onLocInfo: function _onLocInfo(larr) {
        ...
        if (scene == 1074 && query && query.from == "fuhao_guanfang") {
            // 公众号会话下发的小程序消息卡片
        ...
        } else if (scene == 1035 && query && query.from == "fuhao_guanfang") {
            // 公众号自定义菜单
        ...
        if (query && query.sourceCode) {
            ...
            ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeUserFrom, [scene, query.from, query.appid, "GameStart"]);
        }
        ...
        if (roomid != 0 && tableid != 0) {
            ...
            if (ty.SystemInfo.shareTicket != "") {
                ...
                if (!ddz.matchResultPanel && !ddz.matchRevivalPanel && !ddz.arenaResultPanel && !ddz.gameResultPanel && !ddz.hongBaoPanel && !ddz.bannerResurgenceWindow) {
    ...
    onReceiveUserInfo: function onReceiveUserInfo(value) {
        ...
        ddz.gameModel.getFightMatchAdConfig, ddz.gameModel.getMatchingMassageConfig, ddz.gameModel.getResurgenceConfigConfig, ddz.gameModel.getRewardAnbuchangConfigConfig, ddz.gameModel.getcongratulationGetRedPacketConfig, ddz.gameModel.getShareMomentsConfig, ddz.gameModel.getTempData, ddz.gameModel.getOpenBox, ddz.gameModel.getDayInviteReward, ddz.gameModel.getDiversionConfig];
    ...
    _shareValue: function _shareValue(val) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=HallNetWorkCenter.js.map
