...
ddz.gameModel = {
    ...
    parseGame:function (value) {
        ...
        switch (value.result.action){
            ...
            case "new_coupon_reward" : {   //新人红包,回归红包 弹窗
            ...
            case "gain_new_coupon" : {   //新人红包,回归红包 奖励
                if(value.result && value.result.success == 1){
    ...
    saveShareVideoConfigJson:function(value){
        if (hall.GlobalFuncs.isEmptyObject(value)){
            return;
        }
    ...
    getShareVideoConfigJson : function() {
