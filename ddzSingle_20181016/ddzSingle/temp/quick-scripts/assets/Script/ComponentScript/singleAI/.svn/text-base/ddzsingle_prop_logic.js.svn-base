(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/ComponentScript/singleAI/ddzsingle_prop_logic.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '36037odG35Nmq5oUBxaeRKL', 'ddzsingle_prop_logic', __filename);
// Script/ComponentScript/singleAI/ddzsingle_prop_logic.js
...
ddz.offLinePropLogic = function () {
	...
	// 使用双倍卡
	var useDoubleGain = function useDoubleGain() {
		isDoubleGain = true;
	...
	// 使用保护卡
	var useAvoidLose = function useAvoidLose() {
		isAvoidLose = true;
	...
	// 检测选中的牌
	//监测选中的牌数
	var checkPropWorkOnCard = function checkPropWorkOnCard() {
	...
	// 使用弃牌卡
	var useDicardCard = function useDicardCard() {
	...
	// 使用重发卡
	var useRedealCard = function useRedealCard() {
		//重发卡
	...
	var findCardSprite = function findCardSprite(id) {
		//寻找换来的牌
		for (var i = 0; i < playContent._cards.length; i++) {
			if (playContent._cards[i]._info._number != id) {
				continue;
	...
	var useChangeCard = function useChangeCard() {
		if (!checkPropWorkOnCard()) {
			return false;
		}
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ddzsingle_prop_logic.js.map
