...
ddz.AIRobotClasss = cc.Class({
	...
	getPlayerCards: function getPlayerCards(index) {
	...
	getDiPaiCard: function getDiPaiCard() {
		return this.dipai;
	},
	...
	_passivityCards: function _passivityCards() {
		...
		if (types[0].getType() == ddz.Enums.PaixingType.SHUNZI_CARD) {
