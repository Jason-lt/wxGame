...
cc._RF.push(module, 'a0369MsCbhNGoVjUsAwG2A5', 'HallUserInfo', __filename);
...
hall.HallUserInfo = cc.Class({
    ...
    getChip: function getChip() {
        // 大厅版本之后取udata的chip
        var key = ty.UserInfo.userId + "";
        var _chip = hall.GlobalFuncs.ReadNumFromLocalStorage(key, 20);
        // return this.udataInfo.m_chip ? this.udataInfo.m_chip : 0;
        return _chip ? _chip : 0;
    },
    ...
    setChip: function setChip(param) {
        this.udataInfo.m_chip = param;
        var key = ty.UserInfo.userId + "";
        hall.GlobalFuncs.setInLocalStorage(key, param);
    },
        ...
        if (json) {
            ...
            for (var i = 0; i < bagList.length; i++) {
                ...
                if (bagID == 1311) {
                    ...
                    this.udataInfo.jiPaiQiCount = bagInfo["num"];
                }
            }
