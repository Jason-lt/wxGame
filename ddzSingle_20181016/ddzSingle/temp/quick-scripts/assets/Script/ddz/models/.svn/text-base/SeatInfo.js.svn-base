        ...
        for (var i = 0; i < cards.length; i++) {
            ...
            for (var j = 0; j < my_cards.length; j++) {
                ...
                if (c1 == c2 || c1 > 53 && c2 > 53) {
                    //cards里面会是癞子实际值，my_cards里面会是癞子原本值，但都是>53，所以只要都是癞子就符合
                    index = j;
                    break;
                }
            }
