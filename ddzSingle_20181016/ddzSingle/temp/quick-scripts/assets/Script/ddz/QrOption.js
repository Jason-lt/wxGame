(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/ddz/QrOption.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '31a20/vMyFF+qQQNJd+rqs7', 'QrOption', __filename);
// Script/ddz/QrOption.js
...
ddz.QrOption = cc.Class({
    ...
    bindInvite: function bindInvite(pars, scene) {
        ...
        if (from) {
            ...
            // ddz.gameModel.bindNewInviteCode(from);
