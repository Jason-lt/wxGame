(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/shot/shotGlobalFuncs.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '0f720dPBlZKYrEaV4o8sy1S', 'shotGlobalFuncs', __filename);
// Script/shot/shotGlobalFuncs.js
...
shot.GlobalFuncs.setBulletType = function (type) {
	...
	} else if (type == "bulletType6" || type == "bulletType7") {
		//按住连发
...
cc._RF.pop();
        ...
        //# sourceMappingURL=shotGlobalFuncs.js.map
