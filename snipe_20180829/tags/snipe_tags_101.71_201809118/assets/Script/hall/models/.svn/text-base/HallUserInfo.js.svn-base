...
hall.HallUserInfo = cc.Class({
    ...
    parseBagInfo: function(json) {
        if (json) {
            ...
            ty.NotificationCenter.trigger(snipe.EventType.UPDATE_INFINITEBULLET_NUMBER);
            ty.NotificationCenter.trigger(snipe.EventType.UPDATE_LASERAIMING_NUMBER);
            ty.NotificationCenter.trigger(snipe.EventType.UPDATE_DIAMOND_NUMBER);
            ty.NotificationCenter.trigger(snipe.EventType.UPDATE_GRENADE_NUMBER);
