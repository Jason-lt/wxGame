...
ty.PropagateInterface = {
    ...
    getShareConfigInfo: function(reqObj) {
        ...
        var successcb = function(ret) {
            snipe.gameModel.saveShareConfigFromHttp(ret.retmsg);
            ty.NotificationCenter.trigger(snipe.EventType.GET_SHARE_CONFIG_SUCCESS, ret);
        };

        var failcb = function(ret) {
            ty.NotificationCenter.trigger(snipe.EventType.GET_SHARE_CONFIG_FAIL, ret);
        };
    ...
    getUserFeatureInfo: function() {
        ...
        var successcb = function(ret) {
            ty.NotificationCenter.trigger(snipe.EventType.GET_USER_FEATURE_SUCCESS, ret);
        };

        var failcb = function(ret) {
            ty.NotificationCenter.trigger(snipe.EventType.GET_USER_FEATURE_FAIL, ret);
        };
