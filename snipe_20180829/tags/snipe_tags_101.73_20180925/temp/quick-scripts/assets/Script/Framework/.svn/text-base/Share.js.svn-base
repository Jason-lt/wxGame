...
cc._RF.push(module, '7b903pBVc5J8K+O9PygiZuz', 'Share', __filename);
...
shot.Share = {
    ...
    endWithSuccessShare: function endWithSuccessShare() {
        ...
        if (shot.Share.shareType != shot.Share.onShareType.clickStatShareTypeRevial && shot.Share.sharePoint > 10000) {
