...
cc._RF.push(module, '8f104Z7APxNoolLm+I6RRXk', 'shot_prop', __filename);
// Script/ComponentScript/window/shot_prop.js
...
cc.Class({
    ...
    updateInfo: function updateInfo(result) {
        ...
        if (result.itemId && result.itemId == "item:1371") {
            // 无限子弹
            this.state = 0;
        ...
        } else if (result.itemId && result.itemId == "item:1390") {
            // 手榴弹道具
            this.state = 1;
            this.propSprite.spriteFrame = this.propSpriteList[1];
            this.propName.string = "<color=#622508>手榴弹</c><color=#FF3333> x" + hall.ME.udataInfo.grenadeCount + "</color>";
...
cc._RF.pop();
        ...
        //# sourceMappingURL=shot_prop.js.map
