...
cc.Class({
    ...
    onLoad : function () {
        ...
        if(snipe.GameWorld.initBulletType){
            snipe.GlobalFuncs.setBulletType(snipe.GameWorld.initBulletType);
        }else {
...
// }
    ...
    rewardVideoComplete : function(isEnd){
        hall.LOGE("==shot_main==","====rewardVideoComplete============"+hall.adManager.rewardedVideoType);
    ...
    showBanner : function (refresh) {
        hall.adManager.showBannerAd("adunit-56773ac242d78fd0",refresh);
        snipe.GlobalFuncs.showAdBtnWithTag(5002,"normalLevel");
    ...
    onDestroy : function () {
        ...
        // this.userDataList = null;
        this.crazyTimePanel = null;
        snipe.GameWorld.initBulletType = null;
