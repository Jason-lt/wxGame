...
cc._RF.push(module, 'fe9d5KmHL5HV7w2nqABykWN', 'TuyooSDK', __filename);
...
wx.onShow(function (result) {
    ...
    if (query && query.gdt_vid && query.weixinadinfo) {
        ...
        //从小程序消息卡片中点入
        ty.BiLog.clickStat(ty.UserInfo.clickStatEventType.clickStatEventTypeUserFrom, [scene, query.inviteCode, shot.Share.clickStatShareType[query.sourceCode], query.imageType, "CardActive", JSON.stringify(result)]);
    } else {
