...
snipe.AudioHelper = {
	...
	playEffect : function (file, isloop, volume) {
		...
		// playManager.src = ty.SystemInfo.cdnPath + cc.url.raw(file);
		playManager.src = ty.SystemInfo.cdnPath+file;
		if(file == "/resources/sound/gunsnipe.mp3"){
	...
	setEffectsVolume : function (val) {
		hall.GlobalFuncs.setInLocalStorage(snipe.SETTING_EFFECT_KEY, val);
	...
	setMusicVolume : function (val) {
		hall.GlobalFuncs.setInLocalStorage(snipe.SETTING_MUSIC_KEY, val);
	...
	getMusicVolume: function() {
		return hall.GlobalFuncs.ReadNumFromLocalStorage(snipe.SETTING_MUSIC_KEY, cc.audioEngine.getMusicVolume());
	},
	...
	getEffectsVolume: function() {
		return hall.GlobalFuncs.ReadNumFromLocalStorage(snipe.SETTING_EFFECT_KEY, cc.audioEngine.getEffectsVolume());
	}
};
