...
var rankFriendData = function (rankDatas,week,sumScore,userId,type) {
	...
	if(type == "friend"){ //游戏内超越好友
		...
		if(rankDatas.length == 1){
			...
			headImageBg.onload = function (event) {
				var img = event.target;
				context.drawImage(img,214,img.toY,110,110);
				backImage = wx.createImage();
				backImage.toY = 7;
				backImage.onload = function (event) {
					var img = event.target;
					context.drawImage(img,192,img.toY,167,236);
					context.fillStyle="#FFFFFF";
					context.fillText("1",275,35);
					context.fillText(SliceStringToLength(rankDatas[0].nickname,10),275,187);
					context.fillText(rankDatas[0].sumScore,275,217);
				};
				backImage.src = "res/raw-assets/resources/table/nopack/snipe_result_avatar_bg_middle.png";
			};
			...
			headImageBg.onload = function (event) {
				var img = event.target;
				context.drawImage(img,214-83,img.toY,110,110);
				backImage = wx.createImage();
				backImage.toY = 7;
				if(rankSelf == 0){
					backImage.src = "res/raw-assets/resources/table/nopack/snipe_result_avatar_bg_middle.png";
					backImage.isMiddle = true;
				}else {
					backImage.src = "res/raw-assets/resources/table/nopack/snipe_result_avatar_bg_left.png";
					backImage.isMiddle = false;
				}
				backImage.onload = function (event) {
					var img = event.target;
					context.drawImage(img,192-83,img.toY,167,236);
					if(img.isMiddle){
						context.fillStyle="#FFFFFF";
					}else {
						context.fillStyle="#4EA8DA";
					}
					context.fillText("1",275-83,33);
					context.fillText(SliceStringToLength(rankDatas[0].nickname,10),275-83,187-7);
					context.fillText(rankDatas[0].sumScore,275-83,217-7);
				};
			};
			...
			headImageBg2.onload = function (event) {
				...
				backImage2.toY = 7;
				if(rankSelf == 0){
					backImage2.src = "res/raw-assets/resources/table/nopack/snipe_result_avatar_bg_left.png";
					backImage2.isMiddle = false;
				}else {
					backImage2.src = "res/raw-assets/resources/table/nopack/snipe_result_avatar_bg_middle.png";
					backImage2.isMiddle = true;
				}
				backImage2.onload = function (event) {
					...
					context.fillText("2",275+83,33);
					context.fillText(SliceStringToLength(rankDatas[1].nickname,10),275+83,187-7);
					context.fillText(rankDatas[1].sumScore,275+83,217-7);
				};
			};
			...
			headImageBg.onload = function (event) {
				var img = event.target;
				context.drawImage(img,214-192,img.toY,110,110);
				backImage = wx.createImage();
				backImage.toY = 7;
				backImage.onload = function (event) {
					var img = event.target;
					context.drawImage(img,192-192,img.toY,167,236);
					if(img.isMiddle){
						context.fillStyle="#FFFFFF";
					}else {
						context.fillStyle="#4EA8DA";
					}
					context.fillText((index1+1)+"",275-192,35);
					context.fillText(SliceStringToLength(rankDatas[index1].nickname,10),275-192,187);
					context.fillText(rankDatas[index1].sumScore,275-192,217);
				};
				if(rankSelf == 0){
					backImage.src = "res/raw-assets/resources/table/nopack/snipe_result_avatar_bg_middle.png";
					backImage.isMiddle = true;
			...
			headImageBg2.onload = function (event) {
				...
				backImage2.onload = function (event) {
					...
					context.fillText((index2+1)+"",275,35);
					context.fillText(SliceStringToLength(rankDatas[index2].nickname,10),275,187);
					context.fillText(rankDatas[index2].sumScore,275,217);
				};
				if(rankSelf == 0){
					backImage2.src = "res/raw-assets/resources/table/nopack/snipe_result_avatar_bg_left.png";
					backImage2.isMiddle = false;
			...
			headImageBg3.onload = function (event) {
				...
				backImage3.onload = function (event) {
					...
					context.fillText((index3+1)+"",275+192,35);
					context.fillText(SliceStringToLength(rankDatas[index3].nickname,10),275+192,187);
					context.fillText(rankDatas[index3].sumScore,275+192,217);
				};
				if(rankSelf == 0){
					backImage3.src = "res/raw-assets/resources/table/nopack/snipe_result_avatar_bg_left.png";
					backImage3.isMiddle = false;
				}else if(rankSelf == rankDatas.length-1){
					backImage3.src = "res/raw-assets/resources/table/nopack/snipe_result_avatar_bg_middle.png";
					backImage3.isMiddle = true;
				}else {
					backImage3.src = "res/raw-assets/resources/table/nopack/snipe_result_avatar_bg_left.png";
					backImage3.isMiddle = false;
				}
	...
	if(rankDatas && rankDatas.length > 0){
		for (i = 0 ; i < 21 ; i ++){
			...
			if (i < rankDatas.length){
				...
				context.fillStyle="#58C0F9";
				context.textAlign="center";
				context.fillText(rankS,66,baseHeight);
				context.fillStyle="#ffffff";
				context.textAlign="left";
...
var drawUserInformationWithIndexAndData = function(i,rankDatas,context){
	...
	headImage.onload = function (event) {
		...
		context.drawImage(img,113,lineTop,r*2,r*2);
		...
		beforeImage.onload = function (event) {
			...
			context.drawImage(image,113,image.lineTop,r*2,r*2);
		}
	};
	context.fillStyle="#ffffff";
	//昵称
