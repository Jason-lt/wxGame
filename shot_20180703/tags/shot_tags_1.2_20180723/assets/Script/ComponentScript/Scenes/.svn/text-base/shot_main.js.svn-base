...
cc.Class({
    ...
    onLoad : function () {
        ...
        if(hall.GlobalTimer.getCurDay() != hall.GlobalFuncs.ReadStringFromLocalStorage(shot.gameModel.LAST_VIDEO_DAY,"")){
            hall.GlobalFuncs.setInLocalStorage(shot.gameModel.LAST_VIDEO_DAY,hall.GlobalTimer.getCurDay());
...
// }
    ...
    removeCrazyNode : function () {
        ...
        //     shot.curBannerAd.style.left = (hall.adManager.sysInfo.screenWidth - res.width)/2;
        //     shot.curBannerAd.style.top = hall.adManager.sysInfo.screenHeight - 80 + that.rightDistance;
        // });
    },
