...
shot.GlobalFuncs.setBulletType = function (type) {
	...
	shot.GameWorld.doubleGunUseTime = 1;//带功能的枪
	shot.GameWorld.bulletRange = 0;
	...
	switch (type){
		...
		case "bulletType2":{//散弹枪
			...
			break;
		case "bulletType3":{//98k狙击枪攻击力×2
			shot.GameWorld.doubleGunUseTimeCan = shot.GameWorld.propertyConfig.Kar98k.time;
		}
			break;
		case "bulletType4":{//不知道叫什么名字
			shot.GameWorld.doubleGunUseTimeCan = shot.GameWorld.propertyConfig.win94.time;
		}
			break;
		default:break;
	}
...
shot.GlobalFuncs.changeBulletSoundAndSprite = function (type) {
	...
	switch (type){
		...
		case "bulletType3":{//98k狙击枪攻击力×2
			index = 3;
			shot.EffectPath_mp3.gunHits = shot.EffectPath_mp3.gunHits3;
		}
			break;
		case "bulletType4":{//不知道叫什么名字
			index = 4;
			shot.EffectPath_mp3.gunHits = shot.EffectPath_mp3.gunHits4;
		}
			break;
		default:break;
	}
