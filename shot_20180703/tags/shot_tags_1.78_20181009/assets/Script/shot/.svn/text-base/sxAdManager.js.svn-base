                ...
                if (xhr.readyState === 4) {
                    if ((xhr.status >= 200 && xhr.status < 300)) {
                        ...
                        try {
                            ...
                            // 游戏开关
                            self.sxAdInfo = ret;
                            shot.sxAdmanager.refreshIconsWeight();
                            callback();
                    ...
                    if (this.sxAdInfo.icons[iconIndex].openType == 0) {
                        ...
                        wx.navigateToMiniProgram({
                            ...
                            success: function (res) {
                                shot.sxAdmanager.saveItem(shot.sxAdmanager.sxAdInfo.icons[iconIndex].openData[index].imgurl);
                                //刷新权重
                                shot.sxAdmanager.refreshIconsWeight();
                                shot.sxAdmanager.initWeight();
                                //刷新icon
                                shot.sxAdmanager.switchIcon();
