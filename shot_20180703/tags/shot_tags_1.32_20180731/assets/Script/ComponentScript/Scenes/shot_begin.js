...
cc.Class({
    ...
    getAdMsg : function () {
        if(!shot.gameModel.getAllCheckConfig()){
            // if(!hall.adManager.getAdNodeList || !hall.adManager.getAdNodeList.length){
            ...
            // hall.adManager.adNodeObj.showAdNode();
        }
    },
    ...
    onDestroy:function(){
        ...
        // cc.game.removePersistRootNode(shot.adIconBtn);
        // hall.adManager.adNodeObj.hideAdNode();
        hall.adManager.adNodeList = [];
