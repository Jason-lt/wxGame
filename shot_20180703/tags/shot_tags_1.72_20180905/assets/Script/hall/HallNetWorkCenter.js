...
hall.hallNetWorkCenter = {
    ...
    onReceiveUserInfo : function(value){
        ...
        if(shot.Share.isOnShare){
            ...
            if(scene == 1038 && !hall.GlobalFuncs.ReadNumFromLocalStorage(shot.gameModel.OPEN_ADBTN_STATE_TODAY,0)){
                ...
                if (curScene.name == 'shot_main'){
                    ...
                    shot.GlobalFuncs.hideAdBtnWithTag(5002);
                }else {
                    shot.GlobalFuncs.playGetPropBoxAni(rewardIndex);
                ...
                hall.GlobalFuncs.setInLocalStorage(shot.gameModel.OPEN_ADBTN_STATE_TODAY,1);
            }
        }
