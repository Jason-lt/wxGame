...
cc.Class({
    ...
    getSurpassScore : function () {
        ...
        // var baseScore = parseInt(this.initalHeight/jump.gameModel.scoreSub);
        // var topScore = parseInt((this.initalHeight+1136)/jump.gameModel.scoreSub);
        ...
        //             surpass.y = ((score*jump.gameModel.scoreSub-this.initalHeight)*this.windowHeight/1136);
        //             surpass.x = 0;
    ...
    gameOver : function(){
        this.topBgSprite.node.removeAllChildren();
        this.bgSprite.node.removeAllChildren();
        this.bottomBgSprite.node.removeAllChildren();
        this.overDt = 0;
    },
    ...
    update : function(dt) {
        ...
        if(this.type == "middle"){
            ...
            if(canAddScore){
                var score = parseInt((((roleH-this.bgSprite.node.y)*1136/this.windowHeight)+this.initalHeight)/jump.gameModel.scoreSub);
                var topScore = parseInt((((this.windowHeight/2-this.bgSprite.node.y)*1136/this.windowHeight)+this.initalHeight)/jump.gameModel.scoreSub);
                var bottomScore = parseInt((((-this.windowHeight/2-this.bgSprite.node.y)*1136/this.windowHeight)+this.initalHeight)/jump.gameModel.scoreSub);
        ...
        if(!jump.gameModel.isOnAnimation){
            this.moveSpeed -= jump.gameModel.getRoleVerticalAcceleratedSpeed()*dt;
        }
