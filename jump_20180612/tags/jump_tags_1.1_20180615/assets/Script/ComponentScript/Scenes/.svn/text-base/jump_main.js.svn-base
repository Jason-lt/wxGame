...
cc.Class({
    ...
    onLoad : function () {
        ...
        ty.NotificationCenter.listen(jump.EventType.REMOVE_PEDAL,this.removePedal,this);
    ...
    resetMainGame : function (type) {
        ...
        requestAnimationFrame(function () {
            ...
            while (height < topHeight){
                ...
                // var type = that.pedalRandomList[hall.GlobalFuncs.getRandomNumberBefore(that.pedalRandomList.length)];
                // that.addPedalWithHeight(height,type);
                // if(type == "disablePedal"){
                //     var secondType = "disablePedal";
                //     while (secondType == "disablePedal"){
                //         secondType = this.pedalRandomList[hall.GlobalFuncs.getRandomNumberBefore(this.pedalRandomList.length)];
                //     }
                //     this.addPedalWithHeight(this.topPedalHigh,secondType);
                // }
                height += that.gapY;
            }
