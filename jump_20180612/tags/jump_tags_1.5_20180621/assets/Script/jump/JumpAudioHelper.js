...
jump.AudioHelper = {
	...
	setEffectsVolume : function (val) {
		hall.GlobalFuncs.setInLocalStorage(jump.SETTING_EFFECT_KEY, val);
	...
	setMusicVolume : function (val) {
		hall.GlobalFuncs.setInLocalStorage(jump.SETTING_MUSIC_KEY, val);
	...
	getMusicVolume: function() {
		return hall.GlobalFuncs.ReadNumFromLocalStorage(jump.SETTING_MUSIC_KEY, cc.audioEngine.getMusicVolume());
	},
	...
	getEffectsVolume: function() {
		return hall.GlobalFuncs.ReadNumFromLocalStorage(jump.SETTING_EFFECT_KEY, cc.audioEngine.getEffectsVolume());
	}
};
