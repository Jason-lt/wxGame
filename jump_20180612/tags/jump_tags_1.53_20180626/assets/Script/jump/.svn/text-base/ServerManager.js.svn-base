...
cc.Class({
    ...
    onLoad:function () {
        ...
        jump.LOGD(null, "当前的SDK地址:" + serPath);
    ...
    testWithString : function () {
        ...
        var onShowString = hall.GlobalFuncs.ReadStringFromLocalStorage(jump.gameModel.ONSHOW_PARAMS,"");
    ...
    onBtnQRCode:function () {
        ...
        // // jump.AudioHelper.playEffect(filePath);
