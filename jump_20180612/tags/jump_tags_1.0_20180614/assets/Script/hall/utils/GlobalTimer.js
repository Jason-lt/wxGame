...
hall.GlobalTimer = {
    ...
    boot:function () {
        ...
        // ty.NotificationCenter.listen(jump.EventType.GET_TIMESTAMP, this.updateTime, this);
        var that = this;
    ...
    getCurDay:function () {
        ...
        jump.LOGD(hall.GlobalTimer, "今天是:" + dataStr);
        return dataStr;
    },
    /**
     * 获取当前时
    ...
    getCurHours:function () {
        ...
        var dataStr = hour + "";
        jump.LOGD(hall.GlobalTimer, "现在是:" + dataStr + "点");
        return dataStr;
    },
    ...
    updateTime:function (timeObj) {
        jump.LOGD(hall.GlobalTimer, "时间校准。。。");
