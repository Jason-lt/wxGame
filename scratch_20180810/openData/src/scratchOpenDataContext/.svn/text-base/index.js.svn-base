...
var rankFriendData = function (rankDatas,week,sumScore,userId,type) {
	...
	if(type == "friend"){ //游戏内超越好友
		...
		if(rankDatas.length == 1){
			var backImage = wx.createImage();
			backImage.toY = 7;
			backImage.src = "res/raw-assets/resources/table/nopack/scratch_result_avatar_bg_middle.png";
			...
			var backImage = wx.createImage();
			backImage.toY = 7;
			rankSelf == 0 ? backImage.src = "res/raw-assets/resources/table/nopack/scratch_result_avatar_bg_middle.png" :
				backImage.src = "res/raw-assets/resources/table/nopack/scratch_result_avatar_bg_left.png";
			// backImage.src = "res/raw-assets/resources/table/nopack/scratch_result_avatar_bg_middle.png";
			backImage.onload = function (event) {
				var img = event.target;
			...
			var backImage2 = wx.createImage();
			backImage2.toY = 7;
			rankSelf == 0 ? backImage2.src = "res/raw-assets/resources/table/nopack/scratch_result_avatar_bg_right.png" :
				backImage2.src = "res/raw-assets/resources/table/nopack/scratch_result_avatar_bg_middle.png";
			// backImage.src = "res/raw-assets/resources/table/nopack/scratch_result_avatar_bg_middle.png";
			...
			backImage2.toY = 7;
			if(rankSelf == 0){
				backImage2.src = "res/raw-assets/resources/table/nopack/scratch_result_avatar_bg_left.png";
				index2 = rankSelf +1;
			}else if(rankSelf == rankDatas.length-1){
				backImage2.src = "res/raw-assets/resources/table/nopack/scratch_result_avatar_bg_right.png";
				index2 = rankSelf-1;
			}else {
				backImage2.src = "res/raw-assets/resources/table/nopack/scratch_result_avatar_bg_middle.png";
				index2 = rankSelf;
			...
			if(rankSelf == rankDatas.length-1){
				backImage3.src = "res/raw-assets/resources/table/nopack/scratch_result_avatar_bg_middle.png";
				index3 = rankSelf;
			}else if(rankSelf == 0){
				backImage3.src = "res/raw-assets/resources/table/nopack/scratch_result_avatar_bg_right.png";
				index3 = rankSelf+2;
			}else {
				backImage3.src = "res/raw-assets/resources/table/nopack/scratch_result_avatar_bg_right.png";
				index3 = rankSelf + 1;
