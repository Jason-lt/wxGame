...
scratch.AudioHelper = {
	...
	stopEffectWithPlayManager : function (playManager) {
		if(!playManager){
			return
		}
		playManager.stop();
	...
	setEffectsVolume : function (val) {
		hall.GlobalFuncs.setInLocalStorage(scratch.SETTING_EFFECT_KEY, val);
	...
	setMusicVolume : function (val) {
		hall.GlobalFuncs.setInLocalStorage(scratch.SETTING_MUSIC_KEY, val);
	...
	getMusicVolume: function() {
		return hall.GlobalFuncs.ReadNumFromLocalStorage(scratch.SETTING_MUSIC_KEY, cc.audioEngine.getMusicVolume());
	},
	...
	getEffectsVolume: function() {
		return hall.GlobalFuncs.ReadNumFromLocalStorage(scratch.SETTING_EFFECT_KEY, cc.audioEngine.getEffectsVolume());
	}
};
