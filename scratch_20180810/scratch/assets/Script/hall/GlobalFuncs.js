...
hall.GlobalFuncs.getShareRandomNumberWithShareList = function(shareList) {
	var returnRandom = hall.GlobalFuncs.getRandomNumberBefore(200) ;
	var nowIndex = 0;
...
hall.GlobalFuncs.replaceKeyWordInString = function(string) {
	...
	var replaceMap = scratch.Share.shareKeywordReplace;
...
hall.GlobalFuncs.getMoneyStringWithCoupons = function(couponCount) {
	if(couponCount > 1000000){
		return hall.GlobalFuncs.getMoneyStringWithCouponsToZero(couponCount);
	}
	return (couponCount/100).toFixed(2) +"";
};

hall.GlobalFuncs.getMoneyStringWithCouponsToZero = function(couponCount) {
	return (couponCount/100).toFixed(0) +"";
};

hall.GlobalFuncs.getChipStringWithChipCount = function (chip) {
	if(!chip){
		return "0";
	}
	if(chip < 1000){
	...
	var temp1 = chip%1000;
	var temp2 = (parseInt(chip/1000))%1000;
	if(chip < 1000000){
		if(temp1 < 10){
			return temp2+",00"+temp1;
		}else if(temp1 < 100){
			return temp2+",0"+temp1;
		}
		return temp2+","+temp1;
	}
	var temp3 = parseInt(chip/1000000);
	if(temp2 < 10){
		if(temp1 < 10){
			return temp3+",00"+temp2+",00"+temp1;
		}else if(temp1 < 100){
			return temp3+",00"+temp2+",0"+temp1;
		}
		return temp3+",00"+temp2+","+temp1;
	}else if(temp2 < 100){
		if(temp1 < 10){
			return temp3+",0"+temp2+",00"+temp1;
		}else if(temp1 < 100){
			return temp3+",0"+temp2+",0"+temp1;
		}
		return temp3+",0"+temp2+","+temp1;
	}
	if(temp1 < 10){
		return temp3+","+temp2+",00"+temp1;
	}else if(temp1 < 100){
		return temp3+","+temp2+",0"+temp1;
	}
	return temp3+","+temp2+","+temp1;
};

hall.GlobalFuncs.getChipStringWithChipCountForBottom = function (chip) {
	if(!chip){
		return "0";
	}
	if(chip < 100000){
		return hall.GlobalFuncs.getChipStringWithChipCount(chip);
	}
	var temp;
	if(chip < 1000000000){
		temp = hall.GlobalFuncs.getChipStringWithChipCount(parseInt(chip/10000));
		return temp+"万";
	}
	temp = hall.GlobalFuncs.getChipStringWithChipCount(parseInt(chip/100000000));
	return temp+"亿";
};
