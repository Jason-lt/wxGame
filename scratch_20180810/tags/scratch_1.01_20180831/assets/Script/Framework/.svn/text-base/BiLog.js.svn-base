...
ty.BiLog = {
    ...
    uploadLogTimely:function (logtxt) {
        ...
        if(logtxt) {
            ...
            // var configObj = {
            //     'url': 'https://47.94.79.1/api/bilog5/clientlog?cloudname=' + ty.SystemInfo.cloudid + '.' + ty.SystemInfo.clientIdInt,
            //     'header': header,
            //     'postData': postData,
            //     'callback': null
            // };
            ...
            // hall.LOGW("","============uploadLogTimely===================="+configObj);
        }
    },
    ...
    /*BI组打点
     ...
     [ddz.PluginHall.Model.statInfoType[scope.index],scratch.GameId]);
