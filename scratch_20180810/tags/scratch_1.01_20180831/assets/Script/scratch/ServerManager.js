...
cc.Class({
    ...
    onLoad:function () {
        ...
        hall.LOGD(null, "当前的SDK地址:" + serPath);
    ...
    testWithString : function () {
        ...
        // var onShowString = hall.GlobalFuncs.ReadStringFromLocalStorage(scratch.gameModel.ONSHOW_PARAMS,"");
    ...
    onBtnQRCode:function () {
        ...
        // // scratch.AudioHelper.playEffect(filePath);
