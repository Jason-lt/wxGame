...
console.log('scratch_EventType loaded');
...
scratch.EventType = {
    ...
    MSG_GAME : "game",
    MSG_CASH : "cash",
    MSG_STORE_EXCHANGE : "store_exchange",
    ...
    GET_USER_CARD_INFO : "GET_USER_CARD_INFO",
    GET_LUCKY_CASH_INFO : "GET_LUCKY_CASH_INFO",
    GET_EXCHANGE_INFO : "GET_EXCHANGE_INFO",
    GET_STORE_PRODUCT_LIST : "GET_STORE_PRODUCT_LIST",

    GET_INVITE_STATUS : "GET_INVITE_STATUS",

    GET_REWARD_RESULT : "GET_REWARD_RESULT",
